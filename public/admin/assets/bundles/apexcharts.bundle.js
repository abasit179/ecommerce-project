! function(t, e) {
    ...
    function i(i) {
        ...
        return function() {
            var t, e = H(i),
                e = (t = a ? (t = H(this).constructor, Reflect.construct(e, arguments, t)) : e.apply(this, arguments), this);
    ...
    function W(t, e) {
        var i;
        if (t) return "string" == typeof t ? B(t, e) : "Map" === (i = "Object" === (i = Object.prototype.toString.call(t).slice(8, -1)) && t.constructor ? t.constructor.name : i) || "Set" === i ? Array.from(t) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? B(t, e) : void 0
    }
    ...
    t(o, [{
        ...
        value: function(e, i) {
            ...
            return this.isObject(e) && this.isObject(i) && Object.keys(i).forEach(function(t) {
                a.isObject(i[t]) && t in e ? s[t] = a.extend(e[t], i[t]) : Object.assign(s, M({}, t, i[t]))
            }), s
        }
    }, {
        key: "extendArray",
    ...
    var E = o,
        A = (t(tt, [{
            ...
            value: function(t, e, i, a, s, o, r, n) {
                ...
                (!s || -1 < s.indexOf("undefined") || -1 < s.indexOf("NaN")) && (s = l()), (!o || -1 < o.indexOf("undefined") || -1 < o.indexOf("NaN")) && (o = l()), c.globals.shouldAnimate || (r = 1), t.plot(s).animate(1, c.globals.easing, n).plot(s).animate(r, c.globals.easing, n).plot(o).afterAll(function() {
                    E.isNumber(i) ? i === c.globals.series[c.globals.maxValsInArrayIndex].length - 2 && c.globals.shouldAnimate && h.animationCompleted(t) : "none" !== a && c.globals.shouldAnimate && (!c.globals.comboCharts && e === c.globals.series.length - 1 || c.globals.comboCharts) && h.animationCompleted(t), h.showDelayedElements()
                })
            }
        }]), tt),
        P = (t(K, [{
            ...
            value: function(t, e, i) {
                var a = i.blur,
                    ...
                    r = i.color,
                    i = i.opacity,
                    e = t.flood(Array.isArray(r) ? r[e] : r, i).composite(t.sourceAlpha, "in").offset(o, s).gaussianBlur(a).merge(t.source);
            ...
            value: function(t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 0,
                    ...
                    l = this.w;
                return t.unfilter(!0), E.isIE() && "radialBar" === l.config.chart.type || (r = Array.isArray(r) ? r[i] : r, t.filter(function(t) {
                    var e = E.isSafari() || E.isFirefox() || E.isIE() ? t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o) : t.flood(r, n).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(o).merge(t.source);
                    t.blend(t.source, e)
        ...
        Y = (t(Q, [{
            ...
            value: function(t) {
                ...
                return !m || f.globals.resized || f.globals.dataChanged ? !f.globals.resized && f.globals.dataChanged || b.showDelayedElements() : b.animatePathsGradually(T(T({}, g), {}, {
                    speed: c
                })), f.globals.dataChanged && y && v && b.animatePathsGradually(T(T({}, g), {}, {
                    speed: d
                })), k
            }
        }, {
            ...
            value: function(t, e, i, a, s) {
                var o, r = 5 < arguments.length && void 0 !== arguments[5] ? arguments[5] : null,
                    ...
                    c = this.w,
                    d = (e.length < 9 && 0 === e.indexOf("#") && (e = E.hexToRgba(e, a)), i.length < 9 && 0 === i.indexOf("#") && (i = E.hexToRgba(i, s)), 0),
                    g = 1,
                    u = 1,
                    p = null,
            ...
            value: function(t) {
                var i = this,
                    ...
                    p = s = void 0 === s ? "" : s,
                    o = o || "start",
                    n = (h && h.length || (h = u.config.chart.foreColor), n || u.config.chart.fontFamily),
                    l = l || "regular",
                    f = {
                        maxWidth: d,
                        fontSize: r = r || "11px",
                    ...
                    t = Array.isArray(s) ? u.globals.dom.Paper.text(function(t) {
                        for (var e = 0; e < s.length; e++) p = s[e], d && (p = i.getTextBasedOnMaxWidth(T({
                            text: s[e]
                        }, f))), 0 === e ? t.tspan(p) : t.tspan(p).newLine()
                    }) : (d && (p = this.getTextBasedOnMaxWidth(T({
                        text: s
                    }, f))), t ? u.globals.dom.Paper.plain(s) : u.globals.dom.Paper.text(function(t) {
                        return t.tspan(p)
                    }));
                return t.attr({
                    x: e,
                ...
                }), t.node.style.fontFamily = n, t.node.style.opacity = c, t
            }
        }, {
            key: "drawMarker",
            value: function(t, e, i) {
                ...
                }), r = s) : "circle" !== i.shape && i.shape || (E.isNumber(e) || (e = o = 0), r = this.drawCircle(o, {
                    cx: t,
                    cy: e,
                    class: i.class || "",
                    stroke: i.pointStrokeColor,
        ...
        z = (t(J, [{
            ...
            value: function() {
                ...
                if (e = s.xRange / s.gridWidth, i = Math.abs(s.initialMaxX - s.initialMinX) / s.gridWidth, t = s.yRange / s.gridWidth, a = s.xRange / s.gridHeight, r = (r = s.zRange / s.gridHeight * 16) || 1, s.minY !== Number.MIN_VALUE && 0 !== Math.abs(s.minY) && (s.hasNegs = !0), s.isMultipleYAxis)
            ...
            value: function(t, e, i) {
                var a, s;
                return 0 === e ? 0 : (a = 0 === (s = this.w).globals.minYArr[i] ? -1 : this.getBaseLog(t, s.globals.minYArr[i]), s = (0 === s.globals.maxYArr[i] ? 0 : this.getBaseLog(t, s.globals.maxYArr[i])) - a, e < 1 ? e / s : (this.getBaseLog(t, e) - a) / s)
            }
        }, {
            key: "getLogYRatios",
            value: function(t) {
                ...
                return n.yLogRatio = t.slice(), n.logYRange = n.yRange.map(function(t, e) {
                    var i, a, s;
                    if (r.config.yaxis[e] && o.w.config.yaxis[e].logarithmic) return a = -Number.MAX_VALUE, s = Number.MIN_VALUE, n.seriesLog.forEach(function(t, e) {
        ...
        G = (t($, [{
            ...
            key: "getY1Y2",
            value: function(t, e) {
                var i, a, t = "y1" === t ? e.y : e.y2,
                    s = this.w;
                return this.annoCtx.invertAxis ? (i = s.globals.labels.indexOf(t), s.config.xaxis.convertedCatToNumeric && (i = s.globals.categoryLabels.indexOf(t)), (i = s.globals.dom.baseEl.querySelector(".apexcharts-yaxis-texts-g text:nth-child(" + (i + 1) + ")")) && (a = parseFloat(i.getAttribute("y")))) : (i = s.config.yaxis[e.yAxisIndex].logarithmic ? (t = new z(this.annoCtx.ctx).getLogVal(t, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex] : (t - s.globals.minYArr[e.yAxisIndex]) / (s.globals.yRange[e.yAxisIndex] / s.globals.gridHeight), a = s.globals.gridHeight - i, !e.marker || void 0 !== e.y && null !== e.y || (a = 0), s.config.yaxis[e.yAxisIndex] && s.config.yaxis[e.yAxisIndex].reversed && (a = i)), a = "string" == typeof t && -1 < t.indexOf("px") ? parseFloat(t) : a
            }
        }, {
            key: "getX1X2",
            value: function(t, e) {
                var i = this.w,
                    ...
                    a = (this.annoCtx.inversedReversedAxis && (r = (s - e.x) / (o / i.globals.gridWidth)), "category" !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric || this.annoCtx.invertAxis || i.globals.dataFormatXNumeric || (r = this.getStringX(e.x)), (e.x2 - a) / (o / i.globals.gridWidth));
                return this.annoCtx.inversedReversedAxis && (a = (s - e.x2) / (o / i.globals.gridWidth)), "category" !== i.config.xaxis.type && !i.config.xaxis.convertedCatToNumeric || this.annoCtx.invertAxis || i.globals.dataFormatXNumeric || (a = this.getStringX(e.x2)), void 0 !== e.x && null !== e.x || !e.marker || (r = i.globals.gridWidth), "x1" === t && "string" == typeof e.x && -1 < e.x.indexOf("px") && (r = parseFloat(e.x)), "x2" === t && "string" == typeof e.x2 && -1 < e.x2.indexOf("px") && (a = parseFloat(e.x2)), "x1" === t ? r : a
            }
        }, {
            key: "getStringX",
            value: function(t) {
        ...
        _ = (t(U, [{
            ...
            value: function(t, e, i) {
                this.w;
                var a, s, o = this.helpers.getX1X2("x1", t),
                    r = this.helpers.getY1Y2("y1", t);
                E.isNumber(o) && (s = {
                    pSize: t.marker.size,
                ...
                }, s = this.annoCtx.graphics.drawMarker(o + t.marker.offsetX, r + t.marker.offsetY, s), e.appendChild(s.node), a = t.label.text || "", (a = this.annoCtx.graphics.drawText({
                    x: o + t.label.offsetX,
                    y: r + t.label.offsetY - t.marker.size - parseFloat(t.label.style.fontSize) / 1.6,
                    text: a,
                    textAnchor: t.label.textAnchor,
                    fontSize: t.label.style.fontSize,
                    fontFamily: t.label.style.fontFamily,
                    ...
                    rel: i
                }), e.appendChild(a.node), t.customSVG.SVG && ((i = this.annoCtx.graphics.group({
                    class: "apexcharts-point-annotations-custom-svg " + t.customSVG.cssClass
                })).attr({
                    transform: "translate(".concat(o + t.customSVG.offsetX, ", ").concat(r + t.customSVG.offsetY, ")")
                }), i.node.innerHTML = t.customSVG.SVG, e.appendChild(i.node)), t.image.path && (a = t.image.width || 20, e = t.image.height || 20, s = this.annoCtx.addImage({
                ...
                })), t.mouseEnter && s.node.addEventListener("mouseenter", t.mouseEnter.bind(this, t)), t.mouseLeave && s.node.addEventListener("mouseleave", t.mouseLeave.bind(this, t)), t.click) && s.node.addEventListener("click", t.click.bind(this, t))
            }
        }, {
    ...
    function U(t) {
        a(this, U), this.w = t.w, this.annoCtx = t, this.helpers = new G(this.annoCtx)
    }

    function q(t) {
        a(this, q), this.w = t.w, this.annoCtx = t, this.helpers = new G(this.annoCtx)
    }

    function Z(t) {
        a(this, Z), this.w = t.w, this.annoCtx = t, this.invertAxis = this.annoCtx.invertAxis, this.helpers = new G(this.annoCtx)
    }
    ...
    function K(t) {
        a(this, K), this.ctx = t, this.w = t.w
    }

    function tt(t) {
        a(this, tt), this.ctx = t, this.w = t.w, this.setEasingFunctions()
    }
    ...
    function et(t) {
        var e = t.isTimeline,
            ...
            g = ("function" == typeof g && (c = g(c, u)), null != (g = t.config.series[a].data[s]) && g.x && (h = t.config.series[a].data[s].x), e || "datetime" === t.config.xaxis.type && (h = new f(i).xLabelFormat(t.globals.ttKeyFormatter, h, h, {
                i: void 0,
                dateFormatter: new v(i).formatDate,
                w: t
            })), "function" == typeof d && (h = d(h, u)), Number.isFinite(o) && Number.isFinite(r) && (n = o, l = r), ""),
            s = "",
            e = t.globals.colors[a];
        return s = void 0 === t.config.tooltip.x.formatter ? "datetime" === t.config.xaxis.type ? (g = (d = new v(i)).formatDate(d.getDate(n), t.config.tooltip.x.format), d.formatDate(d.getDate(l), t.config.tooltip.x.format)) : (g = n, l) : (g = t.config.tooltip.x.formatter(n), t.config.tooltip.x.formatter(l)), {
            start: n,
            end: l,
            startVal: g,
            endVal: s,
    ...
    var ot, rt, nt, lt, ht, ct = {
        ...
        dt = (t(Je, [{
            ...
            value: function(t, e) {
                ...
                s && (n = this.graphics.drawRect(o.x - b, o.y - t, o.width + b + m, o.height + y + t, p, d || "transparent", 1, g, f, u), a.insertBefore(n.node, i.node))
            }
        }, {
            key: "addImage",
            value: function(t, e) {
            ...
            value: function(t) {
                ...
                }), t = E.listToArray(t), Array.prototype.forEach.call(t, function(t) {
        ...
        v = (t($e, [{
            ...
            value: function(t, e) {
                var i = this.w.globals.locale,
                    ...
                    o = [""].concat(m(i.shortMonths)),
                    r = [""].concat(m(i.days)),
                    i = [""].concat(m(i.shortDays));
            ...
            value: function(t, e) {
                var i = 30;
                return t = E.monthMod(t), !0 == -1 < this.months30.indexOf(t) ? 2 === t && (i = this.isLeapYear(e) ? 29 : 28) : (this.months31.indexOf(t), i = 31), i
            }
        }]), $e),
        f = (t(Ze, [{
            key: "xLabelFormat",
            value: function(t, e, i, a) {
                var s, o = this.w;
                return "datetime" === o.config.xaxis.type && void 0 === o.config.xaxis.labels.formatter && void 0 === o.config.tooltip.x.formatter ? (s = new v(this.ctx)).formatDate(s.getDate(e), o.config.tooltip.x.format) : t(e, i, a)
            }
        }, {
            ...
            value: function(t, e, i) {
                var a = this.w;
                return t = E.isNumber(t) ? 0 !== a.globals.yValueDecimal ? t.toFixed(void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal) : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? t.toFixed(1) : t.toFixed(0) : t
            }
        }, {
            ...
            value: function() {
                ...
                return s.globals.xaxisTooltipFormatter = function(t) {
                    ...
                    var e;
                    return E.isNumber(t) ? s.config.xaxis.convertedCatToNumeric || "numeric" !== s.config.xaxis.type ? s.globals.isBarHorizontal && s.globals.maxY - s.globals.minYArr < 4 ? t.toFixed(1) : t.toFixed(0) : E.isNumber(s.config.xaxis.decimalsInFloat) ? t.toFixed(s.config.xaxis.decimalsInFloat) : 0 < (e = s.globals.maxX - s.globals.minX) && e < 100 ? t.toFixed(1) : t.toFixed(0) : t
        ...
        n = (t(qe, [{
            ...
            key: "sparkline",
            value: function(t) {
                return this.hideYAxis(), E.extend(t, {
                    grid: {
                        show: !1,
                        padding: {
                            left: 0,
            ...
            key: "funnel",
            value: function() {
                return this.hideYAxis(), T(T({}, this.bar()), {}, {
                    chart: {
                        animations: {
                            easing: "linear",
                            speed: 800,
            ...
            value: function() {
                return {
                    ...
                    tooltip: {
                        ...
                        followCursor: !0,
                        custom: function(t) {
                            return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal ? (i = et(T(T({}, e = t), {}, {
                                isTimeline: !0
                            })), a = i.color, s = i.seriesName, o = i.ylabel, r = i.startVal, i = i.endVal, it(T(T({}, e), {}, {
                                color: a,
                                seriesName: s,
                                ylabel: o,
                                start: r,
                                end: i
                            }))) : (a = et(e = t), s = a.color, o = a.seriesName, r = a.ylabel, i = a.start, a = a.end, it(T(T({}, e), {}, {
                                color: s,
                                seriesName: o,
                                ylabel: r,
                                start: i,
            ...
            value: function() {
                return {
                    ...
                    tooltip: {
                        ...
                        followCursor: !0,
                        custom: function(t) {
                            return e = et(t = t), i = e.color, a = e.seriesName, s = e.ylabel, o = e.start, e = e.end, it(T(T({}, t), {}, {
                                color: i,
                                seriesName: a,
                                ylabel: s,
                                start: o,
            ...
            value: function() {
                var t = this.bar();
                return T(T({}, t), {}, {
                    plotOptions: T(T({}, t.plotOptions), {}, {
                        bar: T(T({}, t.plotOptions.bar), {}, {
        ...
        p = (t(Ue, [{
            ...
            value: function(i, t) {
                var a = new d,
                    e = ((void 0 === i.yaxis || !i.yaxis || Array.isArray(i.yaxis) && 0 === i.yaxis.length) && (i.yaxis = {}), i.yaxis.constructor !== Array && window.Apex.yaxis && window.Apex.yaxis.constructor !== Array && (i.yaxis = E.extend(i.yaxis, window.Apex.yaxis)), i.yaxis.constructor !== Array ? i.yaxis = [E.extend(a.yAxis, i.yaxis)] : i.yaxis = E.extendArray(i.yaxis, a.yAxis), !1),
                    s = (i.yaxis.forEach(function(t) {
                        t.logarithmic && (e = !0)
                    }), i.series);
                return t && !s && (s = t.config.series), e && s.length !== i.yaxis.length && s.length && (i.yaxis = s.map(function(t, e) {
                    return t.name || (s[e].name = "series-".concat(e + 1)), i.yaxis[e] ? (i.yaxis[e].seriesName = s[e].name, i.yaxis[e]) : ((t = E.extend(a.yAxis, i.yaxis[0])).show = !1, t)
        ...
        S = (t(Ve, [{
            ...
            value: function(t) {
                ...
                i.appendChild(a), a.setAttributeNS(window.SVG.xlink, "href", s), Y.setAttrs(a, {
                    x: 0,
                    y: 0,
            ...
            value: function(t) {
                ...
                return -1 === o.indexOf("rgb") ? o.length < 9 && (l = E.hexToRgba(o, n)) : -1 < o.indexOf("rgba") && (n = E.getOpacityFromRGBA(o)), t.opacity && (n = t.opacity), "pattern" === r && (i = this.handlePatternFill({
            ...
            value: function(t) {
                ...
                var o, a = this.opts,
                    ...
                    i = (-1 < h.indexOf("rgba") && (c = E.getOpacityFromRGBA(h)), void 0 === s.gradient.opacityTo ? i : Array.isArray(s.gradient.opacityTo) ? s.gradient.opacityTo[t] : s.gradient.opacityTo);
                return void 0 === s.gradient.gradientToColors || 0 === s.gradient.gradientToColors.length ? o = "dark" === s.gradient.shade ? n.shadeColor(-1 * parseFloat(s.gradient.shadeIntensity), -1 < e.indexOf("rgb") ? E.rgb2hex(e) : e) : n.shadeColor(parseFloat(s.gradient.shadeIntensity), -1 < e.indexOf("rgb") ? E.rgb2hex(e) : e) : s.gradient.gradientToColors[a.seriesNumber] ? -1 < (o = n = s.gradient.gradientToColors[a.seriesNumber]).indexOf("rgba") && (i = E.getOpacityFromRGBA(n)) : o = e, s.gradient.gradientFrom && (h = s.gradient.gradientFrom), s.gradient.gradientTo && (o = s.gradient.gradientTo), s.gradient.inverseColors && (n = h, h = o, o = n), -1 < h.indexOf("rgb") && (h = E.rgb2hex(h)), -1 < o.indexOf("rgb") && (o = E.rgb2hex(o)), r.drawGradient(l, h, o, c, i, a.size, s.gradient.stops, s.gradient.colorStops, t)
            }
        }]), Ve),
        w = (t(Ge, [{
                ...
                if ((0 < r.globals.markers.size[e] || o || d) && (h = c.group({
                    ...
                    for (var g = 0; g < l.x.length; g++) {
                        var u = 1 === i && 1 === g ? 1 : 1 === i && 0 === g ? 0 : i,
                            p = "apexcharts-marker";
                        "line" !== r.config.chart.type && "area" !== r.config.chart.type || r.globals.comboCharts || r.config.tooltip.intersect || (p += " no-pointer-events"), (Array.isArray(r.config.markers.size) ? 0 < r.globals.markers.size[e] : 0 < r.config.markers.size) || o || d ? (E.isNumber(l.y[g]) ? p += " w".concat(E.randomId()) : p = "apexcharts-nullpoint", p = this.getMarkerConfig({
                            cssClass: p,
                            seriesIndex: e,
                            dataPointIndex: u
                        }), r.config.series[n].data[u] && (r.config.series[n].data[u].fillColor && (p.pointFillColor = r.config.series[n].data[u].fillColor), r.config.series[n].data[u].strokeColor) && (p.pointStrokeColor = r.config.series[n].data[u].strokeColor), a && (p.pSize = a), (l.x[g] < 0 || l.x[g] > r.globals.gridWidth || l.y[g] < 0 || l.y[g] > r.globals.gridHeight) && (p.pSize = 0), (s = c.drawMarker(l.x[g], l.y[g], p)).attr("rel", u), s.attr("j", u), s.attr("index", e), s.node.setAttribute("default-marker-size", p.pSize), new P(this.ctx).setSelectionFilter(s, e, u), this.addEvents(s), h && h.add(s)) : (void 0 === r.globals.pointsArray[e] && (r.globals.pointsArray[e] = []), r.globals.pointsArray[e].push([l.x[g], l.y[g]]))
                    }
                return h
            }
        }, {
        ...
        pt = (t(Be, [{
                ...
                if (h.attr("clip-path", "url(#gridRectMarkerMask".concat(a.globals.cuid, ")")), Array.isArray(r.x))
                    for (var c = 0; c < r.x.length; c++) {
                        var d = e + 1,
                            ...
                            f = (n !== 1 / 0 && (f = a.config.plotOptions.bubble, p = a.globals.seriesZ[o][d], f.zScaling && (p /= n), f.minBubbleRadius && p < f.minBubbleRadius && (p = f.minBubbleRadius), f.maxBubbleRadius) && p > f.maxBubbleRadius && (p = f.maxBubbleRadius), a.config.chart.animations.enabled || (u = p), r.x[c]),
                            x = r.y[c],
                            u = u || 0;
            ...
            value: function(t, e, i, a, s, o, r) {
                ...
                if ("circle" === p.shape ? f = u.drawCircle(i) : "square" !== p.shape && "rect" !== p.shape || (f = u.drawRect(0, 0, p.width - p.pointStrokeWidth / 2, p.height - p.pointStrokeWidth / 2, p.pRadius)), n.config.series[l].data[o] && n.config.series[l].data[o].fillColor && (d = n.config.series[l].data[o].fillColor), f.attr({
                    ...
                    }), n.config.chart.dropShadow.enabled && (i = n.config.chart.dropShadow, c.dropShadow(f, i, s)), !this.initialAnim || n.globals.dataChanged || n.globals.resized ? n.globals.animationEnded = !0 : (u = n.config.chart.animations.speed, h.animateMarker(f, 0, "circle" === p.shape ? a : {
                        width: p.width,
                        height: p.height
                    }, u, n.globals.easing, function() {
                        window.setTimeout(function() {
                            h.animationCompleted(f)
                        }, 100)
                    })), n.globals.dataChanged && "circle" === p.shape)
                    if (this.dynamicAnim) {
                        var x, b, m, y = n.config.chart.animations.dynamicAnimation.speed;
                        null != (l = n.globals.previousPaths[s] && n.globals.previousPaths[s][r]) && (x = l.x, b = l.y, m = void 0 !== l.r ? l.r : a);
                        for (var v = 0; v < n.globals.collapsedSeries.length; v++) n.globals.collapsedSeries[v].index === s && (y = 1, a = 0);
                        h.animateCircle(f, {
                            cx: x,
                            cy: b,
                            r: m
        ...
        k = (t(We, [{
            ...
            value: function(t, e, i, a, s, o, r) {
                var n = this.w,
                    l = !1,
                    i = new Y(this.ctx).getTextRects(i, r),
                    r = i.width,
                    h = i.height,
                    h = ((e = e < 0 ? 0 : e) > n.globals.gridHeight + h && (e = n.globals.gridHeight + h / 2), void 0 === n.globals.dataLabelsRects[a] && (n.globals.dataLabelsRects[a] = []), n.globals.dataLabelsRects[a].push({
                        x: t,
                        y: e,
                        width: r,
                        height: h
                    }), n.globals.dataLabelsRects[a].length - 2),
                    c = void 0 !== n.globals.lastDrawnDataLabelsIndexes[a] ? n.globals.lastDrawnDataLabelsIndexes[a][n.globals.lastDrawnDataLabelsIndexes[a].length - 1] : 0;
                return void 0 !== n.globals.dataLabelsRects[a][h] && (t > (h = n.globals.dataLabelsRects[a][c]).x + h.width + 2 || e > h.y + h.height + 2 || t + r < h.x) && (l = !0), {
                    x: t,
                    y: e,
                    textRects: i,
            ...
            value: function(t) {
                ...
                for (var g = t.group({
                    ...
                    }, "bubble" === l.config.chart.type ? (f = x(p = l.globals.seriesZ[s][d]), c = a.y[u], c = new pt(this.ctx).centerTextInBubble(c, s, d).y) : void 0 !== p && (f = x(p)), this.plotDataLabelsText({
                        x: b,
                        y: c,
                        text: f,
                        i: s,
            ...
            value: function(t) {
                ...
                Array.isArray(i.config.dataLabels.enabledOnSeries) && i.config.dataLabels.enabledOnSeries.indexOf(r) < 0 || (e = {
                    x: s,
                    y: o,
                    drawnextLabel: !0,
                    textRects: null
                }, t && (e = this.dataLabelsCorrection(s, o, l, r, n, p, parseInt(g.style.fontSize, 10))), i.globals.zoomed || (s = e.x, o = e.y), e.textRects && (s < -10 - e.textRects.width || s > i.globals.gridWidth + e.textRects.width + 10) && (l = ""), t = i.globals.dataLabels.style.colors[r], "function" == typeof(t = ("bar" === i.config.chart.type || "rangeBar" === i.config.chart.type) && i.config.plotOptions.bar.distributed || i.config.dataLabels.distributed ? i.globals.dataLabels.style.colors[n] : t) && (t = t({
                    series: i.globals.series,
                    seriesIndex: r,
                    dataPointIndex: n,
                    w: i
                })), u && (t = u), p = g.offsetX, u = g.offsetY, "bar" !== i.config.chart.type && "rangeBar" !== i.config.chart.type || (u = p = 0), e.drawnextLabel && ((e = a.drawText({
                    width: 100,
                    ...
                    cx: s,
                    cy: o
                }), g.dropShadow.enabled && (a = g.dropShadow, new P(this.ctx).dropShadow(e, a)), d.add(e), void 0 === i.globals.lastDrawnDataLabelsIndexes[r] && (i.globals.lastDrawnDataLabelsIndexes[r] = []), i.globals.lastDrawnDataLabelsIndexes[r].push(n)))
            }
        }, {
            ...
            value: function(t, e) {
                var i = this.w,
                    ...
                    r = e.width,
                    n = e.height,
                    e = new Y(this.ctx).drawRect(e.x - s, e.y - o / 2, r + 2 * s, n + o, a.borderRadius, "transparent" === i.config.chart.background ? "#fff" : i.config.chart.background, a.opacity, a.borderWidth, a.borderColor);
                return a.dropShadow.enabled && new P(this.ctx).dropShadow(e, a.dropShadow), e
            }
        }, {
        ...
        C = (t(Ne, [{
            ...
            value: function() {
                var t = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0],
                    ...
                    a = this.w,
                    s = E.clone(a.globals.initialSeries);
            ...
            value: function(t, e) {
                ...
                if ("mousemove" === t.type) {
                    var e = parseInt(e.getAttribute("rel"), 10) - 1,
                        s = null,
                        o = null;
                    i.globals.axisCharts || "radialBar" === i.config.chart.type ? i.globals.axisCharts ? (s = i.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(e, "']")), o = i.globals.dom.baseEl.querySelector(".apexcharts-datalabels[data\\:realIndex='".concat(e, "']"))) : s = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(1 + e, "']")) : s = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(1 + e, "'] path"));
        ...
        ft = (t(Oe, [{
            ...
            value: function(t, e) {
                ...
                for (var r = 0; r < t[e].data.length; r++) void 0 !== t[e].data[r].y && (Array.isArray(t[e].data[r].y) ? this.twoDSeries.push(E.parseNumber(t[e].data[r].y[t[e].data[r].y.length - 1])) : this.twoDSeries.push(E.parseNumber(t[e].data[r].y))), void 0 !== t[e].data[r].goals && Array.isArray(t[e].data[r].goals) ? (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(t[e].data[r].goals)) : (void 0 === this.seriesGoals[e] && (this.seriesGoals[e] = []), this.seriesGoals[e].push(null));
                for (var n = 0; n < t[o].data.length; n++) {
                    ...
                    l || c ? l || i.xaxis.convertedCatToNumeric ? (c = a.isBarHorizontal && a.isRangeData, "datetime" !== i.xaxis.type || c ? (this.fallbackToCategory = !0, this.twoDSeriesX.push(t[o].data[n].x)) : this.twoDSeriesX.push(s.parseDate(t[o].data[n].x))) : "datetime" === i.xaxis.type ? this.twoDSeriesX.push(s.parseDate(t[o].data[n].x.toString())) : (a.dataFormatXNumeric = !0, a.isXNumeric = !0, this.twoDSeriesX.push(parseFloat(t[o].data[n].x))) : (h ? this.fallbackToCategory = !0 : (a.isXNumeric = !0, a.dataFormatXNumeric = !0), this.twoDSeriesX.push(t[o].data[n].x))
                }
            ...
            value: function(t) {
                var a, s, e = this,
                    ...
                    r = this.w.globals,
                    n = new v(i),
                    l = (0 < o.labels.length ? o.labels : o.xaxis.categories).slice();
                r.isRangeBar = "rangeBar" === o.chart.type && r.isBarHorizontal, r.hasXaxisGroups = "category" === o.xaxis.type && 0 < o.xaxis.group.groups.length, r.hasXaxisGroups && (r.groups = o.xaxis.group.groups), r.hasSeriesGroups = null == (i = t[0]) ? void 0 : i.group, r.hasSeriesGroups && (a = [], s = m(new Set(t.map(function(t) {
                    return t.group
                }))), t.forEach(function(t, e) {
                    var i = s.indexOf(t.group);
                    a[i] || (a[i] = []), a[i].push(t.name)
                }), r.seriesGroups = a);
                            ...
                            r.isXNumeric = !0; {
                                ...
                                for (var c = 0; c < l.length; c++)
                                    if ("string" == typeof l[c]) {
                                        if (!n.isValidDate(l[c])) throw new Error("You have provided invalid Date format. Please provide a valid JavaScript Date");
                                        e.twoDSeriesX.push(n.parseDate(l[c]))
                                    } else e.twoDSeriesX.push(l[c])
                            }
                            r.seriesX.push(this.twoDSeriesX)
                        } else "numeric" === o.xaxis.type && (r.isXNumeric = !0, 0 < l.length) && (this.twoDSeriesX = l, r.seriesX.push(this.twoDSeriesX));
            ...
            value: function(t) {
                var e = this.w,
                    i = e.config,
                    a = e.globals;
                this.excludeCollapsedSeriesInYAxis(), this.fallbackToCategory = !1, this.ctx.core.resetGlobals(), this.ctx.core.isMultipleY(), a.axisCharts ? (this.parseDataAxisCharts(t), this.coreUtils.getLargestSeries()) : this.parseDataNonAxisCharts(t), i.chart.stacked && (e = new C(this.ctx), a.series = e.setNullSeriesToZeroValues(a.series)), this.coreUtils.getSeriesTotals(), a.axisCharts && (a.stackedSeriesTotals = this.coreUtils.getStackedSeriesTotals()), this.coreUtils.getPercentSeries(), a.dataFormatXNumeric || a.isXNumeric && ("numeric" !== i.xaxis.type || 0 !== i.labels.length || 0 !== i.xaxis.categories.length) || this.handleExternalLabelsData(t);
        ...
        L = (t(He, [{
            ...
            value: function(t, e, i, a) {
                var s, o = 4 < arguments.length && void 0 !== arguments[4] ? arguments[4] : [],
                    ...
                    }), u = s === p, i = e[a].position, c = e[a].value) : "datetime" === l.config.xaxis.type && void 0 === g && (c = ""), void 0 === c && (c = ""), c = Array.isArray(c) ? c : c.toString(), new Y(this.ctx)),
                ...
                return {
                    x: i,
                    text: c = !Array.isArray(c) && (0 === c.indexOf("NaN") || 0 === c.toLowerCase().indexOf("invalid") || 0 <= c.toLowerCase().indexOf("infinity") || 0 <= o.indexOf(c) && t) ? "" : c,
                    textRect: h,
                    isBold: u
                }
            }
                ...
                if (a.show && 0 < e) {
                    ...
                    for (var c = e; 0 <= c; c--) {
                        var d = h + e / 10 + n.config.yaxis[s].labels.offsetY - 1,
                            d = (n.globals.isBarHorizontal && (d = o * c), "heatmap" === n.config.chart.type && (d += o / 2), l.drawLine(t + i.offsetX - a.width + a.offsetX, d + a.offsetY, t + i.offsetX + a.offsetX, d + a.offsetY, a.color));
                        r.add(d), h += o
                    }
                }
            }
        ...
        xt = (t(De, [{
            ...
            value: function(t) {
                var e;
                return E.isIE11() ? (e = 0, t.replace(/xmlns="http:\/\/www.w3.org\/2000\/svg"/g, function(t) {
            ...
            value: function(n) {
                ...
                return new Promise(function(e) {
                    ...
                    window.canvg && E.isIE11() ? ((s = window.canvg.Canvg.fromString(r, a, {
                        ignoreClear: !0,
                        ignoreDimensions: !0
            ...
            value: function(t) {
                var s = this,
                    ...
                    f = Math.max.apply(Math, m(h.map(function(t) {
                    ...
                    b = function(t) {
                        var e, i, a = "";
                        return d.globals.axisCharts ? ("category" !== d.config.xaxis.type && !d.config.xaxis.convertedCatToNumeric || (a = d.globals.isBarHorizontal ? (e = d.globals.yLabelFormatters[0], i = new C(s.ctx).getActiveConfigSeriesIndex(), e(d.globals.labels[t], {
                            seriesIndex: i,
                            dataPointIndex: t,
                            w: d
                        })) : o.getLabel(d.globals.labels, d.globals.timescaleLabels, 0, t).text), "datetime" === d.config.xaxis.type && (d.config.xaxis.categories.length ? a = d.config.xaxis.categories[t] : d.config.labels.length && (a = d.config.labels[t]))) : a = d.config.labels[t], Array.isArray(a) && (a = a.join(" ")), E.isNumber(a) ? a : a.split(c).join("")
                    };
                g.push(d.config.chart.toolbar.export.csv.headerCategory), "boxPlot" === d.config.chart.type ? (g.push("minimum"), g.push("q1"), g.push("median"), g.push("q3"), g.push("maximum")) : "candlestick" === d.config.chart.type ? (g.push("open"), g.push("high"), g.push("low"), g.push("close")) : "rangeBar" === d.config.chart.type ? (g.push("minimum"), g.push("maximum")) : h.map(function(t, e) {
                    ...
                    if (d.globals.axisCharts) {
                        var i, a = t,
                            s = e;
                        if (g.length && 0 === s && u.push(g.join(c)), a.data) {
                            a.data = a.data.length && a.data || m(Array(f)).map(function() {
                                return ""
                            });
                            for (var o = 0; o < a.data.length; o++) {
                                g = [];
                                var r = b(o);
                                if (r || (x.isFormatXY() ? r = h[s].data[o].x : x.isFormat2DArray() && (r = h[s].data[o] ? h[s].data[o][0] : "")), 0 === s) {
                                    g.push((i = r, "datetime" === d.config.xaxis.type && 10 <= String(i).length ? d.config.chart.toolbar.export.csv.dateFormatter(r) : E.isNumber(r) ? r : r.split(c).join("")));
                                    for (var n, l = 0; l < d.globals.series.length; l++) x.isFormatXY() ? g.push(null == (n = h[l].data[o]) ? void 0 : n.y) : g.push(p[l][o])
                                }("candlestick" === d.config.chart.type || a.type && "candlestick" === a.type) && (g.pop(), g.push(d.globals.seriesCandleO[s][o]), g.push(d.globals.seriesCandleH[s][o]), g.push(d.globals.seriesCandleL[s][o]), g.push(d.globals.seriesCandleC[s][o])), ("boxPlot" === d.config.chart.type || a.type && "boxPlot" === a.type) && (g.pop(), g.push(d.globals.seriesCandleO[s][o]), g.push(d.globals.seriesCandleH[s][o]), g.push(d.globals.seriesCandleM[s][o]), g.push(d.globals.seriesCandleL[s][o]), g.push(d.globals.seriesCandleC[s][o])), "rangeBar" === d.config.chart.type && (g.pop(), g.push(d.globals.seriesRangeStart[s][o]), g.push(d.globals.seriesRangeEnd[s][o])), g.length && u.push(g.join(c))
                            }
                        }
                    } else(g = []).push(d.globals.labels[e].split(c).join("")), g.push(p[e]), u.push(g.join(c))
                }), i += u.join(t), this.triggerDownload("data:text/csv; charset=utf-8," + encodeURIComponent("\ufeff" + i), e || d.config.chart.toolbar.export.csv.filename, ".csv")
            }
        }, {
            key: "triggerDownload",
            value: function(t, e, i) {
        ...
        g = (t(Re, [{
            ...
            value: function(s, o, r, n, t, l) {
                ...
                0 === w && w < v && (w = v), y = t ? (e = 1 < w ? w - 1 : w, h = u.globals.gridWidth / e, y + l(0, h) / 2 + u.config.xaxis.labels.offsetX) : (h = u.globals.gridWidth / w, y + l(0, h) + u.config.xaxis.labels.offsetX);
                for (var i = 0; i <= v - 1; i++) ! function(i) {
                    var t, e = y - l(i, h) / 2 + u.config.xaxis.labels.offsetX,
                        e = (0 === i && 1 === v && h / 2 === y && 1 === w && (e = u.globals.gridWidth / 2), c.axesUtils.getLabel(n, u.globals.timescaleLabels, e, i, d, p, s)),
                        a = 28;
                    ...
                    }), s) && ((t = document.createElementNS(u.globals.SVGNS, "title")).textContent = Array.isArray(e.text) ? e.text.join(" ") : e.text, a.node.appendChild(t), "" !== e.text) && (d.push(e.text), g.push(e)), i < v - 1 && (y += l(i + 1, h))
                }(i)
            }
        }, {
        ...
        bt = (t(Fe, [{
            ...
            value: function(t) {
                var e = t.i,
                    ...
                    e = ((0 === a && 0 === o || 0 === i && 0 === s) && (l = !0), a === n.globals.gridHeight && o === n.globals.gridHeight && (l = !0), !n.globals.isBarHorizontal || 0 !== e && e !== r - 1 || (l = !0), new Y(this).drawLine(i - (h ? d : 0), a, s + (h ? d : 0), o, n.config.grid.borderColor, c));
            ...
            value: function(t) {
                ...
                if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                    ...
                    }), new g(this.ctx).drawXaxisTicks(s, 0, i.globals.dom.elGraphical), a = s = s + i.globals.gridWidth / e + .3;
        ...
        x = (t(Ye, [{
            ...
            value: function(t, e) {
                var i = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10,
                    ...
                    o = this.w,
                    r = Math.abs(e - t);
                if ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, r)) && (i = o.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !E.isNumber(t) && !E.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) return e = i, this.linearScale(t = 0, e, i);
                e < t ? (console.warn("axis.min cannot be greater than axis.max"), e = t + .1) : t === e && (t = 0 === t ? 0 : t - .5, e = 0 === e ? 2 : e + .5);
                var n = [],
                    a = (r < 1 && s && ("candlestick" === o.config.chart.type || "candlestick" === o.config.series[a].type || "boxPlot" === o.config.chart.type || "boxPlot" === o.config.series[a].type || o.globals.isRangeData) && (e *= 1.01), i + 1),
                    o = (a < 2 ? a = 2 : 2 < a && (a -= 2), r / a),
                    a = Math.floor(E.log10(o)),
                    a = Math.pow(10, a),
                    o = Math.round(o / a),
                    l = (o = o < 1 ? 1 : o) * a,
                    o = l * Math.floor(t / l),
                    ...
                    c = o;
                if (s && 2 < r)
                    for (; n.push(E.stripNumber(c, 7)), !((c += l) > h););
                else {
                    var d = t;
                    (n = []).push(E.stripNumber(d, 7));
            ...
            value: function(t, e, i) {
                var a = t;
                return (a = void 0 !== e && this.w.config.yaxis[e].labels.formatter && void 0 === this.w.config.yaxis[e].tickAmount && (e = Number(this.w.config.yaxis[e].labels.formatter(1)), E.isNumber(e)) && 0 === this.w.globals.yValueDecimal ? Math.ceil(i) : a) < t ? a : t
            }
        }, {
            ...
            value: function(t, e, i) {
                var a = this.w.globals,
                    ...
                    r = (void 0 === a.yAxisScale[t] && (a.yAxisScale[t] = []), Math.abs(i - e));
                o.logarithmic && r <= 5 && (a.invalidLogScale = !0), o.logarithmic && 5 < r ? (a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(e, i, o.logBase), a.yAxisScale[t] = o.forceNiceScale ? this.logarithmicScaleNice(e, i, o.logBase) : this.logarithmicScale(e, i, o.logBase)) : i !== -Number.MAX_VALUE && E.isNumber(i) ? (a.allSeriesCollapsed = !1, void 0 === o.min && void 0 === o.max || o.forceNiceScale ? (s = void 0 === s.yaxis[t].max && void 0 === s.yaxis[t].min || s.yaxis[t].forceNiceScale, a.yAxisScale[t] = this.niceScale(e, i, o.tickAmount || (r < 5 && 1 < r ? r + 1 : 5), t, s)) : a.yAxisScale[t] = this.linearScale(e, i, o.tickAmount, t)) : a.yAxisScale[t] = this.linearScale(0, 5, 5)
            }
        }, {
            key: "setXScale",
            value: function(t, e) {
                var i = this.w,
                    ...
                    i = i.config.xaxis,
                    s = Math.abs(e - t);
                return e !== -Number.MAX_VALUE && E.isNumber(e) ? a.xAxisScale = this.linearScale(t, e, i.tickAmount || (s < 5 && 1 < s ? s + 1 : 5), 0) : a.xAxisScale = this.linearScale(0, 5, 5), a.xAxisScale
            }
        }, {
            ...
            value: function() {
                ...
                r.yaxis.forEach(function(i, a) {
                    var s = a,
                        t = (r.series.forEach(function(t, e) {
                            t.name === i.seriesName && (s = e, h.push(a !== e ? {
                                index: e,
                                similarIndex: a,
                                alreadyExists: !0
                            } : {
            ...
            value: function(t, s, e) {
                var n = this,
                    ...
                    }), Array.apply(null, Array(r.length)).map(Number.prototype.valueOf, Number.MIN_VALUE)),
            ...
            value: function(t, c, d) {
                var g, u, p = (t = t || this).w;
                return p.globals.isMultipleYAxis || p.globals.collapsedSeries.length ? console.warn("autoScaleYaxis is not supported in a multi-yaxis chart.") : (g = p.globals.seriesX[0], u = p.config.chart.stacked, c.forEach(function(a, t) {
                    for (var s = 0, e = 0; e < g.length; e++)
                        if (g[e] >= d.xaxis.min) {
                            s = e;
                            break
                        }
                    var r, n, o = p.globals.minYArr[t],
                        l = p.globals.maxYArr[t],
                        h = p.globals.stackedSeriesTotals;
                    p.globals.series.forEach(function(i, t) {
                        var e = i[s];
                        u ? (e = h[s], r = n = e, h.forEach(function(t, e) {
                            g[e] <= d.xaxis.max && g[e] >= d.xaxis.min && (n < t && null !== t && (n = t), i[e] < r) && null !== i[e] && (r = i[e])
                        })) : (r = n = e, i.forEach(function(i, a) {
                            var s, o;
                            g[a] <= d.xaxis.max && g[a] >= d.xaxis.min && (o = s = i, p.globals.series.forEach(function(t, e) {
                                null !== i && (s = Math.min(t[a], s), o = Math.max(t[a], o))
                            }), n < o && null !== o && (n = o), s < r) && null !== s && (r = s)
                        })), void 0 === r && void 0 === n && (r = o, n = l), n *= n < 0 ? .9 : 1.1, 0 == (r *= r < 0 ? 1.1 : .9) && 0 === n && (r = -1, n = 1), n < 0 && n < l && (n = l), r < 0 && o < r && (r = o), 1 < c.length ? (c[t].min = void 0 === a.min ? r : a.min, c[t].max = void 0 === a.max ? n : a.max) : (c[0].min = void 0 === a.min ? r : a.min, c[0].max = void 0 === a.max ? n : a.max)
                    })
                })), c
            }
        }]), Ye),
        mt = (t(Ee, [{
            ...
            value: function() {
                ...
                if (e.isXNumeric)
                    for (var s = 0; s < e.series.length; s++)
                        if (e.labels[s])
                            for (var o = 0; o < e.labels[s].length; o++) null !== e.labels[s][o] && E.isNumber(e.labels[s][o]) && (e.maxX = Math.max(e.maxX, e.labels[s][o]), e.initialMaxX = Math.max(e.maxX, e.labels[s][o]), e.minX = Math.min(e.minX, e.labels[s][o]), e.initialMinX = Math.min(e.minX, e.labels[s][o]));
            ...
            value: function() {
                var t, a, s, e = this,
                    o = this.w.globals;
                o.series.length && ((t = o.seriesGroups).length || (t = [this.w.config.series.map(function(t) {
                    return t.name
                })]), a = {}, s = {}, t.forEach(function(i) {
                    a[i] = [], s[i] = [], e.w.config.series.map(function(t, e) {
                        return -1 < i.indexOf(t.name) ? e : null
                    }).filter(function(t) {
                        return null !== t
                    }).forEach(function(t) {
                        for (var e = 0; e < o.series[o.maxValsInArrayIndex].length; e++) void 0 === a[i][e] && (a[i][e] = 0, s[i][e] = 0), null !== o.series[t][e] && E.isNumber(o.series[t][e]) && (0 < o.series[t][e] ? a[i][e] += parseFloat(o.series[t][e]) + 1e-4 : s[i][e] += parseFloat(o.series[t][e]))
                    })
                }), Object.entries(a).forEach(function(t) {
                    var i = N(t, 1)[0];
                    a[i].forEach(function(t, e) {
                        o.maxY = Math.max(o.maxY, a[i][e]), o.minY = Math.min(o.minY, s[i][e])
                    })
                }))
            }
        }]), Ee),
        yt = (t(Xe, [{
            ...
            value: function(t) {
                ...
                if (!this.axesUtils.isYAxisHidden(t)) {
                    ...
                    if (i.config.yaxis[t].labels.show)
                        ...
                        }), h === f && (v = d), p.add(d), (g = document.createElementNS(i.globals.SVGNS, "title")).textContent = Array.isArray(c) ? c.join(" ") : c, d.node.appendChild(g), 0 !== i.config.yaxis[t].labels.rotate && (u = a.rotateAroundCenter(v.node), h = a.rotateAroundCenter(d.node), d.node.setAttribute("transform", "rotate(".concat(i.config.yaxis[t].labels.rotate, " ").concat(u.x, " ").concat(h.y, ")"))), b += x;
            ...
            value: function() {
                ...
                (t = E.listToArray(t)).forEach(function(t, e) {
                    ...
                    s && !s.floating && void 0 !== s.labels.align && (i = o.globals.dom.baseEl.querySelector(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-texts-g")), e = o.globals.dom.baseEl.querySelectorAll(".apexcharts-yaxis[rel='".concat(e, "'] .apexcharts-yaxis-label")), e = E.listToArray(e), a = i.getBoundingClientRect(), "left" === s.labels.align ? (e.forEach(function(t, e) {
        ...
        At = (t(Ie, [{
            ...
            value: function() {
                ...
                t.config.xaxis.crosshairs.show && ("gradient" === o && (f = e.drawGradient("vertical", r, n, l, h, null, a, null)), o = e.drawRect(), 1 === t.config.xaxis.crosshairs.width && (o = e.drawLine()), r = t.globals.gridHeight, (!E.isNumber(r) || r < 0) && (r = 0), n = t.config.xaxis.crosshairs.width, (!E.isNumber(n) || n < 0) && (n = 0), o.attr({
        ...
        St = (t(Pe, [{
            ...
            value: function(t) {
                ...
                0 !== i.responsive.length && ((s = i.responsive.slice()).sort(function(t, e) {
                    ...
                    if (e < i) {
                        e = z.extendArrayProps(o, n.globals.initialConfig, n), t = E.extend(e, t);
                        t = E.extend(n.config, t), r.overrideResponsiveOptions(t)
                    } else
                        for (var a = 0; a < s.length; a++) i < s[a].breakpoint && (t = z.extendArrayProps(o, s[a].options, n), t = E.extend(n.config, t), r.overrideResponsiveOptions(t))
                }, t ? (e = z.extendArrayProps(o, t, n), e = E.extend(n.config, e), i(e = E.extend(e, t))) : i({}))
            }
        }, {
        ...
        Lt = (t(Ce, [{
            ...
            value: function(t) {
                var e = this.w,
                    ...
                    s = i.offsetY,
                    o = "middle";
                "left" === i.align ? (a = 10, o = "start") : "right" === i.align && (a = e.globals.svgWidth - 10, o = "end"), a += i.offsetX, s = s + parseInt(i.style.fontSize, 10) + i.margin / 2, void 0 !== i.text && ((a = new Y(this.ctx).drawText({
                    x: a,
                    y: s,
                    text: i.text,
                    textAnchor: o,
        ...
        Pt = (t(Se, [{
            ...
            value: function() {
                var t = this.w,
                    ...
                    i = (t.config.legend.height || "top" !== t.config.legend.position && "bottom" !== t.config.legend.position || (e.style.maxHeight = t.globals.svgHeight / 2 + "px"), Object.assign({}, E.getBoundingClientRect(e)));
            ...
            value: function(t, e) {
                ...
                }), a = Math.max.apply(Math, m(i)), t = e[i.indexOf(a)]), t
            }
        }]), Se),
        It = (t(Ae, [{
            ...
            value: function() {
                ...
                return n.config.xaxis.convertedCatToNumeric && 0 === l.length && (l = n.globals.categoryLabels), 0 < n.globals.timescaleLabels.length ? (t = {
                    ...
                    dateFormatter: new v(this.dCtx.ctx).formatDate,
                    w: n
                }), (n.config.xaxis.convertedCatToNumeric && void 0 === e || "" === String(e).trim()) && (i = e = "1"), s = r = (a = new Y(this.dCtx.ctx)).getTextRects(e, n.config.xaxis.labels.style.fontSize), e !== i && (s = a.getTextRects(i, n.config.xaxis.labels.style.fontSize)), (t = {
            ...
            value: function() {
                ...
                return r.globals.hasXaxisGroups ? (t = (null == (t = r.config.xaxis.group.style) ? void 0 : t.fontSize) || r.config.xaxis.labels.style.fontSize, i = r.globals.groups.map(function(t) {
                    return t.title
                }), e = E.getLargestStringFromArr(i), i = this.dCtx.dimHelpers.getLargestStringFromMultiArr(e, i), o = s = (a = new Y(this.dCtx.ctx)).getTextRects(e, t), e !== i && (o = a.getTextRects(i, t)), e = {
            ...
            value: function() {
                var t = this.w,
                    e = 0,
                    i = 0;
                return void 0 !== t.config.xaxis.title.text && (e = (t = new Y(this.dCtx.ctx).getTextRects(t.config.xaxis.title.text, t.config.xaxis.title.style.fontSize)).width, i = t.height), {
                    width: e,
                    height: i
                }
            }
            ...
            value: function() {
                ...
                return 1.05 * (i = new Y(this.dCtx.ctx).getTextRects(i, t.config.xaxis.labels.style.fontSize)).width * e.length > t.globals.gridWidth && 0 !== t.config.xaxis.labels.rotate && (t.globals.overlappingXLabels = !0), i
            }
        }, {
        ...
        Tt = (t(ke, [{
            ...
            value: function() {
                ...
                return h.config.yaxis.map(function(t, e) {
                    var i, a, s, o, r = h.globals.yAxisScale[e],
                        n = 0;
                    !g.isYAxisHidden(e) && t.labels.show && void 0 !== t.labels.minWidth && (n = t.labels.minWidth), !g.isYAxisHidden(e) && t.labels.show && r.result.length ? (a = h.globals.yLabelFormatters[e], s = r.niceMin === Number.MIN_VALUE ? 0 : r.niceMin, void 0 !== (i = r = a(s = String(s).length > String(r.niceMax).length ? s : r.niceMax, {
                        seriesIndex: e,
                        dataPointIndex: -1,
                        w: h
                    })) && 0 !== r.length || (r = s), h.globals.isBarHorizontal && (d = 0, s = h.globals.labels.slice(), r = a(r = E.getLargestStringFromArr(s), {
                        seriesIndex: e,
                        dataPointIndex: -1,
                        w: h
                    }), i = l.dCtx.dimHelpers.getLargestStringFromMultiArr(r, s)), a = new Y(l.dCtx.ctx), e = "rotate(".concat(t.labels.rotate, " 0 0)"), o = s = a.getTextRects(r, t.labels.style.fontSize, t.labels.style.fontFamily, e, !1), r !== i && (o = a.getTextRects(i, t.labels.style.fontSize, t.labels.style.fontFamily, e, !1)), c.push({
                        width: (n > o.width || n > s.width ? n : (o.width > s.width ? o : s).width) + d,
            ...
            value: function() {
                ...
                return t.config.yaxis.map(function(t, e) {
                    var i, a;
                    t.show && void 0 !== t.title.text ? (a = new Y(s.dCtx.ctx), i = "rotate(".concat(t.title.rotate, " 0 0)"), a = a.getTextRects(t.title.text, t.title.style.fontSize, t.title.style.fontFamily, i, !1), o.push({
                        width: a.width,
                        height: a.height
                    })) : o.push({
                        width: 0,
        ...
        Mt = (t(we, [{
            ...
            value: function(t) {
                ...
                return r.globals.noData || r.globals.allSeriesCollapsed ? 0 : (o = r.config.chart.type, a = (e = function(t) {
                    return "bar" === t || "rangeBar" === t || "candlestick" === t || "boxPlot" === t
                })(o) ? r.config.series.length : 1, (i = 0) < r.globals.comboBarCount && (a = r.globals.comboBarCount), r.globals.collapsedSeries.forEach(function(t) {
                    e(t.type) && --a
                }), r.config.chart.stacked && (a = 1), (e(o) || 0 < r.globals.comboBarCount) && r.globals.isXNumeric && !r.globals.isBarHorizontal && 0 < a && (o = (o = (o = Math.abs(r.globals.initialMaxX - r.globals.initialMinX)) <= 3 ? r.globals.dataPoints : o) / t, t / 2 < (s = r.globals.minXDiff && 0 < r.globals.minXDiff / o ? r.globals.minXDiff / o : s) && (s /= 2), i = (i = (i = s / a * parseInt(r.config.plotOptions.bar.columnWidth, 10) / 100) < 1 ? 1 : i) / (1 < a ? 1 : 1.5) + 5, r.globals.barPadForNumericAxis = i), i)
            }
        }, {
        ...
        zt = (t(ve, [{
            ...
            value: function() {
                function t() {
                    a.translateX = h, a.gridHeight = a.svgHeight - e.lgRect.height - c - (e.isSparkline || "treemap" === i.config.chart.type ? 0 : i.globals.rotateXLabels ? 10 : 15), a.gridWidth = a.svgWidth - h
                }
                var e = this,
                    i = this.w,
                    a = i.globals,
                    ...
                    r = (i.globals.yLabelsCoords = [], i.globals.yTitleCoords = [], i.config.yaxis.map(function(t, e) {
                ...
                switch ("top" === i.config.xaxis.position && (d = a.xAxisHeight - i.config.xaxis.axisTicks.height - 5), i.config.legend.position) {
                    ...
                    case "top":
                        ...
                        break;
                    case "left":
                        a.translateY = d, a.translateX = this.lgRect.width + h, a.gridHeight = a.svgHeight - c - 12, a.gridWidth = a.svgWidth - this.lgRect.width - h;
                        break;
                    case "right":
                        a.translateY = d, a.translateX = h, a.gridHeight = a.svgHeight - c - 12, a.gridWidth = a.svgWidth - this.lgRect.width - h - 5;
                        break;
                    default:
                        throw new Error("Legend position not supported")
                }
                this.dimGrid.setGridXPosForDualYAxis(o, s), new yt(this.ctx).setYAxisXPosition(s, o)
            }
        }, {
            ...
            value: function() {
                ...
                if (!i.legend.show || i.legend.floating) e.gridHeight = e.svgHeight - i.grid.padding.left + i.grid.padding.right, e.gridWidth = e.gridHeight, e.translateY = s, e.translateX = o + (e.svgWidth - e.gridWidth) / 2;
        ...
        Xt = (t(ye, [{
            ...
            value: function(t, e) {
                ...
                o.globals.axisCharts || "radialBar" === o.config.chart.type ? (o.globals.resized = !0, i = a = null, o.globals.risingSeries = [], i = o.globals.axisCharts ? (a = o.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(t, "']")), parseInt(a.getAttribute("data:realIndex"), 10)) : (a = o.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']")), parseInt(a.getAttribute("rel"), 10) - 1), e ? [{
                    ...
                    seriesEl: a,
                    realIndex: i
                })) : (e = o.globals.dom.Paper.select(" .apexcharts-series[rel='".concat(t + 1, "'] path")), "pie" !== (a = o.config.chart.type) && "polarArea" !== a && "donut" !== a || (t = o.config.plotOptions.pie.donut.labels, new Y(this.lgCtx.ctx).pathMouseDown(e.members[0], null), this.lgCtx.ctx.pie.printDataLabelsInner(e.members[0].node, t)), e.fire("click"))
            }
        }, {
            key: "hideSeries",
            value: function(t) {
                ...
                a.globals.axisCharts ? (e = !1, a.config.yaxis[t] && a.config.yaxis[t].show && a.config.yaxis[t].showAlways && (e = !0, a.globals.ancillaryCollapsedSeriesIndices.indexOf(t) < 0) && (a.globals.ancillaryCollapsedSeries.push({
                    index: t,
                    data: s[t].data.slice(),
                    type: i.parentNode.className.baseVal.split("-")[1]
                }), a.globals.ancillaryCollapsedSeriesIndices.push(t)), e || (a.globals.collapsedSeries.push({
                    index: t,
                    data: s[t].data.slice(),
                    type: i.parentNode.className.baseVal.split("-")[1]
                }), a.globals.collapsedSeriesIndices.push(t), e = a.globals.risingSeries.indexOf(t), a.globals.risingSeries.splice(e, 1))) : (a.globals.collapsedSeries.push({
                    index: t,
                    data: s[t]
                }), a.globals.collapsedSeriesIndices.push(t));
                for (var o = i.childNodes, r = 0; r < o.length; r++) o[r].classList.contains("apexcharts-series-markers-wrap") && (o[r].classList.contains("apexcharts-hide") ? o[r].classList.remove("apexcharts-hide") : o[r].classList.add("apexcharts-hide"));
        ...
        Et = (t(me, [{
            ...
            value: function() {
                ...
                if ((t.legend.showForSingleSeries && 1 === e.series.length || this.isBarsDistributed || 1 < e.series.length || !e.axisCharts) && t.legend.show) {
                    ...
                    this.drawLegends(), E.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.legendHelpers.getLegendStyles()) : this.legendHelpers.appendToForeignObject(), "bottom" === t.legend.position || "top" === t.legend.position ? this.legendAlignHorizontal() : "right" !== t.legend.position && "left" !== t.legend.position || this.legendAlignVertical()
                }
            }
        }, {
            key: "drawLegends",
            value: function() {
                ...
                for (var o = e.globals.legendFormatter, r = e.config.legend.inverseOrder, n = r ? a.length - 1 : 0; r ? 0 <= n : n <= a.length - 1; r ? n-- : n++) {
                    ...
                    var u = document.createElement("span"),
                        ...
                        w = u.style,
                        x = (w.background = s[n], w.color = s[n], w.setProperty("background", s[n], "important"), e.config.legend.markers.fillColors && e.config.legend.markers.fillColors[n] && (w.background = e.config.legend.markers.fillColors[n]), void 0 !== e.globals.seriesColors[n] && (w.background = e.globals.seriesColors[n], w.color = e.globals.seriesColors[n]), w.height = Array.isArray(x) ? parseFloat(x[n]) + "px" : parseFloat(x) + "px", w.width = Array.isArray(b) ? parseFloat(b[n]) + "px" : parseFloat(b) + "px", w.left = (Array.isArray(p) ? parseFloat(p[n]) : parseFloat(p)) + "px", w.top = (Array.isArray(f) ? parseFloat(f[n]) : parseFloat(f)) + "px", w.borderWidth = Array.isArray(m) ? m[n] : m, w.borderColor = Array.isArray(y) ? y[n] : y, w.borderRadius = Array.isArray(v) ? parseFloat(v[n]) + "px" : parseFloat(v) + "px", e.config.legend.markers.customHTML && (Array.isArray(e.config.legend.markers.customHTML) ? e.config.legend.markers.customHTML[n] && (u.innerHTML = e.config.legend.markers.customHTML[n]()) : u.innerHTML = e.config.legend.markers.customHTML()), Y.setAttrs(u, {
                            rel: n + 1,
                            "data:collapsed": h || c
                    ...
                    f = (f = e.config.legend.labels.useSeriesColors ? e.globals.colors[n] : Array.isArray(e.config.legend.labels.colors) ? null == (p = e.config.legend.labels.colors) ? void 0 : p[n] : e.config.legend.labels.colors) || e.config.chart.foreColor, m = (b.style.color = f, b.style.fontSize = parseFloat(e.config.legend.fontSize) + "px", b.style.fontWeight = e.config.legend.fontWeight, b.style.fontFamily = i || e.config.chart.fontFamily, Y.setAttrs(b, {
                        rel: n + 1,
                        i: n,
                        "data:default-text": encodeURIComponent(l),
                        "data:collapsed": h || c
                    }), x.appendChild(u), x.appendChild(b), new z(this.ctx));
                    e.config.legend.showForZeroSeries || 0 === m.getSeriesTotalByIndex(n) && m.seriesHaveSameValues(n) && !m.isSeriesNull(n) && -1 === e.globals.collapsedSeriesIndices.indexOf(n) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(n) && x.classList.add("apexcharts-hidden-zero-series"), e.config.legend.showForNullSeries || m.isSeriesNull(n) && -1 === e.globals.collapsedSeriesIndices.indexOf(n) && -1 === e.globals.ancillaryCollapsedSeriesIndices.indexOf(n) && x.classList.add("apexcharts-hidden-null-series"), e.globals.dom.elLegendWrap.appendChild(x), e.globals.dom.elLegendWrap.classList.add("apexcharts-align-".concat(e.config.legend.horizontalAlign)), e.globals.dom.elLegendWrap.classList.add("apx-legend-position-" + e.config.legend.position), x.classList.add("apexcharts-legend-series"), x.style.margin = "".concat(e.config.legend.itemMargin.vertical, "px ").concat(e.config.legend.itemMargin.horizontal, "px"), e.globals.dom.elLegendWrap.style.width = e.config.legend.width ? e.config.legend.width + "px" : "", e.globals.dom.elLegendWrap.style.height = e.config.legend.height ? e.config.legend.height + "px" : "", Y.setAttrs(x, {
                        rel: n + 1,
                        seriesName: E.escapeString(a[n]),
                        "data:collapsed": h || c
                    }), (h || c) && x.classList.add("apexcharts-inactive-legend"), e.config.legend.onItemClick.toggleDataSeries || x.classList.add("apexcharts-no-click")
                }
            ...
            value: function(t) {
                ...
                "heatmap" === e.config.chart.type || this.isBarsDistributed ? i && (e = parseInt(t.target.getAttribute("rel"), 10) - 1, this.ctx.events.fireEvent("legendHover", [this.ctx, e, this.w]), new C(this.ctx).highlightRangeInSeries(t, t.target)) : !t.target.classList.contains("apexcharts-inactive-legend") && i && new C(this.ctx).toggleSeriesOnHover(t, t.target)
            }
        }, {
            key: "onLegendClick",
            value: function(t) {
        ...
        Yt = (t(be, [{
            ...
            value: function() {
                ...
                n.forEach(function(t, e) {
                    t.index && E.moveIndexInArray(n, e, t.index)
                });
            ...
            value: function(t, e) {
                ...
                }, i = E.clone(a.globals.initialConfig.yaxis), a.config.chart.zoom.autoScaleYaxis && (i = new x(this.ctx).autoScaleY(this.ctx, i, {
                    xaxis: t
                })), a.config.chart.group || (e.yaxis = i), this.w.globals.zoomed = !0, this.ctx.updateHelpers._updateOptions(e, !1, this.w.config.chart.animations.dynamicAnimation.enabled), this.zoomCallback(t, i)) : this.handleZoomReset()
            }
        }, {
            key: "zoomCallback",
            value: function(t, e) {
            ...
            value: function(t) {
                this.ctx.getSyncedCharts().forEach(function(t) {
                    var e = t.w,
                        ...
                        }), e.globals.zoomed = !1, t.ctx.series.emptyCollapsedSeries(E.clone(e.globals.initialSeries)));
        ...
        Ft = (e(c, Yt), ht = i(c), t(c, [{
            ...
            value: function(t) {
                ...
                }), Y.setAttrs(n.node, o)), r.globals.selectionEnabled) && (l.attr({
                    x: e,
                    y: i,
                    width: 0 < a ? a : 0,
                    height: 0 < s ? s : 0,
            ...
            value: function(t, e) {
                ...
                s.globals.selection = t, "function" == typeof s.config.chart.events.selection && s.globals.selectionEnabled && (clearTimeout(this.w.globals.selectionResizeTimer), this.w.globals.selectionResizeTimer = window.setTimeout(function() {
                    var t = a.gridRect.getBoundingClientRect(),
                        e = r.node.getBoundingClientRect(),
                        e = {
                            xaxis: {
                                min: s.globals.xAxisScale.niceMin + (e.left - t.left) * o.xRatio,
                                max: s.globals.xAxisScale.niceMin + (e.right - t.left) * o.xRatio
                            },
                            yaxis: {
                                min: s.globals.yAxisScale[0].niceMin + (t.bottom - e.bottom) * o.yRatio[0],
                                max: s.globals.yAxisScale[0].niceMax - (e.top - t.top) * o.yRatio[0]
                            }
                        };
            ...
            value: function(t) {
                ...
                r.config.yaxis.forEach(function(t, e) {
                    d.push(r.globals.yAxisScale[e].niceMax - l.yRatio[e] * n.startY), g.push(r.globals.yAxisScale[e].niceMax - l.yRatio[e] * n.endY)
                }), n.dragged && (10 < n.dragX || 10 < n.dragY) && h !== c && (r.globals.zoomEnabled ? (i = E.clone(r.globals.initialConfig.yaxis), e = E.clone(r.globals.initialConfig.xaxis), r.globals.zoomed = !0, r.config.xaxis.convertedCatToNumeric && (h = Math.floor(h), c = Math.floor(c), h < 1 && (h = 1, c = r.globals.dataPoints), c - h < 2) && (c = h + 1), "xy" !== t && "x" !== t || (e = {
                    min: h,
                    max: c
                }), "xy" !== t && "y" !== t || i.forEach(function(t, e) {
                    i[e].min = g[e], i[e].max = d[e]
                }), r.config.chart.zoom.autoScaleYaxis && (i = new x(n.ctx).autoScaleY(n.ctx, i, {
                    xaxis: e
                    ...
                    min: h,
                    max: c
                }, "xy" !== t && "y" !== t || (a = E.clone(r.config.yaxis)).forEach(function(t, e) {
            ...
            value: function(t, e) {
                var i = this.w,
                    ...
                    o = (i.config.chart.zoom.autoScaleYaxis && (s = new x(this.ctx).autoScaleY(this.ctx, s, {
                        xaxis: a
                    })), {
                        xaxis: {
                            min: t,
        ...
        Rt = (t(xe, [{
            ...
            value: function(t) {
                var e = t.hoverArea,
                    ...
                    h = this.hasBars(),
                    a = (!s.globals.comboCharts && !h || s.config.xaxis.convertedCatToNumeric || (n = o / s.globals.dataPoints), a - i.left - s.globals.barPadForNumericAxis),
                    t = t - i.top,
                    i = (a < 0 || t < 0 || o < a || r < t ? (e.classList.remove("hovering-zoom"), e.classList.remove("hovering-pan")) : s.globals.zoomEnabled ? (e.classList.remove("hovering-pan"), e.classList.add("hovering-zoom")) : s.globals.panEnabled && (e.classList.remove("hovering-zoom"), e.classList.add("hovering-pan")), Math.round(a / n)),
                    e = Math.floor(t / l),
                    l = (h && !s.config.xaxis.convertedCatToNumeric && (i = Math.ceil(a / n), --i), null),
                    c = [],
                    d = [];
                return s.globals.seriesXvalues.forEach(function(t) {
                ...
                }), s.globals.isXNumeric && (n = a * ((h = this.ttCtx.getElGrid().getBoundingClientRect()).width / o), o = t * (h.height / r), l = (h = this.closestInMultiArray(n, o, c, d)).index, i = h.j, null !== l) && (c = s.globals.seriesXvalues[l], i = this.closestInArray(n, c).index), s.globals.capturedSeriesIndex = null === l ? -1 : l, (!i || i < 1) && (i = 0), s.globals.isBarHorizontal ? s.globals.capturedDataPointIndex = e : s.globals.capturedDataPointIndex = i, {
                    capturedSeries: l,
        ...
        Dt = (t(fe, [{
            ...
            value: function(t) {
                ...
                for (var i = 0, a = g.globals.series.length - 1; i < g.globals.series.length; i++, a--) ! function(t, e) {
                    ...
                    })))), null === l && (o = i.yLbFormatter(g.globals.series[n], T(T({}, g), {}, {
                        seriesIndex: n,
                        dataPointIndex: n
                    }))), r.DOMHandling({
                        i: n,
        ...
        Ht = (t(pe, [{
            ...
            value: function(t) {
                var e = this.ttCtx,
                    ...
                    r = new C(this.ctx).getActiveConfigSeriesIndex("asc", ["line", "area", "scatter", "bubble"]),
            ...
            value: function(t, e) {
                var i = this.w,
                    ...
                    o = (i.globals.isBarHorizontal && (o = new C(this.ctx).getActiveConfigSeriesIndex("desc") + 1), i.globals.dom.baseEl.querySelector(".apexcharts-bar-series .apexcharts-series[rel='".concat(o, "'] path[j='").concat(t, "'], .apexcharts-candlestick-series .apexcharts-series[rel='").concat(o, "'] path[j='").concat(t, "'], .apexcharts-boxPlot-series .apexcharts-series[rel='").concat(o, "'] path[j='").concat(t, "'], .apexcharts-rangebar-series .apexcharts-series[rel='").concat(o, "'] path[j='").concat(t, "']"))),
        ...
        Ot = (t(ue, [{
            ...
            value: function() {
                var t = this.w,
                    e = new Y(this.ctx),
                    i = new w(this.ctx),
                    a = m(a = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series"));
        ...
        Nt = (t(ge, [{
            ...
            value: function(t) {
                var e, i, a, s, o, r, n = t.e,
                    ...
                    c = this.w,
                    d = this.ttCtx;
                return n.target.classList.contains("apexcharts-marker") && (e = parseInt(l.paths.getAttribute("cx"), 10), i = parseInt(l.paths.getAttribute("cy"), 10), a = parseFloat(l.paths.getAttribute("val")), s = parseInt(l.paths.getAttribute("rel"), 10), o = parseInt(l.paths.parentNode.parentNode.parentNode.getAttribute("rel"), 10) - 1, d.intersect && (r = E.findAncestor(l.paths, "apexcharts-series")) && (o = parseInt(r.getAttribute("data:realIndex"), 10)), d.tooltipLabels.drawSeriesTexts({
                    ttItems: l.ttItems,
                    i: o,
                    j: s,
            ...
            value: function(t) {
                ...
                return (v.contains("apexcharts-bar-area") || v.contains("apexcharts-candlestick-area") || v.contains("apexcharts-boxPlot-area") || v.contains("apexcharts-rangebar-area")) && (r = (v = d.target).getBoundingClientRect(), e = t.elGrid.getBoundingClientRect(), i = r.height, y = r.height, a = r.width, s = parseInt(v.getAttribute("cx"), 10), o = parseInt(v.getAttribute("cy"), 10), m = parseFloat(v.getAttribute("barWidth")), r = ("touchmove" === d.type ? d.touches[0] : d).clientX, u = parseInt(v.getAttribute("j"), 10), f = parseInt(v.parentNode.getAttribute("rel"), 10) - 1, n = v.getAttribute("data-range-y1"), l = v.getAttribute("data-range-y2"), g.globals.comboCharts && (f = parseInt(v.parentNode.getAttribute("data:realIndex"), 10)), v = function(t) {
                    ...
                    e: d
                }), b = g.config.tooltip.followCursor ? g.globals.isBarHorizontal ? (x = r - e.left + 15, h()) : (x = v(), d.clientY - e.top - p.tooltipRect.ttHeight / 2 - 15) : g.globals.isBarHorizontal ? ((x = s) < p.xyRatios.baseLineInvertedY && (x = s - p.tooltipRect.ttWidth), h()) : (x = v(), o)), {
                    x: x,
                    y: b,
                    barHeight: y,
                    barWidth: m,
        ...
        Wt = (t(de, [{
            ...
            value: function() {
                for (var s = this.w, e = this.ttCtx, t = 0; t < s.config.yaxis.length; t++) ! function(i) {
                    var t = s.config.yaxis[i].opposite || s.config.yaxis[i].crosshairs.opposite,
                        ...
                        t = (s.globals.yAxisSameScaleIndices.map(function(t, e) {
                            t.map(function(t, e) {
            ...
            value: function(t, e, i) {
                ...
                o.yaxisTooltips[t] && (i = (e - (a = o.getElGrid().getBoundingClientRect()).top) * i.yRatio[t], s = r.globals.maxYArr[t] - r.globals.minYArr[t], r = r.globals.minYArr[t] + (s - i), o.tooltipPosition.moveYCrosshairs(e - a.top), o.yaxisTooltipText[t].innerHTML = n(r), o.tooltipPosition.moveYAxisTooltip(t))
            }
        }]), de),
        Bt = (t(ce, [{
            key: "getElTooltip",
            ...
            value: function(t) {
                ...
                }, i.e = t, !i.tooltipUtil.hasBars() || s.globals.comboCharts || i.isBarShared || this.tConfig.onDatasetHover.highlightDataSeries && new C(e).toggleSeriesOnHover(t, t.target.parentNode), i.fixedTooltip && i.drawFixedTooltipRect(), s.globals.axisCharts ? i.axisChartsTooltips({
                    e: t,
                    opt: a,
            ...
            value: function(t, e, i, a, s) {
                ...
                if (o) {
                    if (e.tooltipLabels.drawSeriesTexts(T(T({}, s), {}, {
                ...
                } else e.tooltipLabels.drawSeriesTexts(T({
                    shared: !1
        ...
        Gt = (t(he, [{
            ...
            value: function(t) {
                var e = t.x,
                    ...
                    t = t.renderedPath,
                    f = this.w,
                    x = new Y(this.barCtx.ctx),
                    b = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[n] : this.barCtx.strokeWidth,
                    m = e + parseFloat(d * p),
                    y = i + parseFloat(c * p);
                f.globals.isXNumeric && !f.globals.isBarHorizontal && (m = e + parseFloat(d * (p + 1)), y = i + parseFloat(c * (p + 1)) - b);
                var p = null,
                    v = e,
                    w = i,
                    ...
                    u = (void 0 !== u && this.barCtx.isRangeBar && (w = y = u), void 0 !== g && this.barCtx.isVerticalGroupedRangeBar && (v = m = g), k.offsetX),
                    g = k.offsetY,
                    C = {
                        width: 0,
                        height: 0
                    },
                    x = (f.config.dataLabels.enabled && (L = this.barCtx.series[o][r], C = x.getTextRects(f.globals.yLabelFormatters[0](L), parseFloat(k.style.fontSize))), {
                        x: e,
                        y: i,
                        i: o,
                        j: r,
                    ...
                    L = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(x) : this.calculateColumnsDataLabelsPosition(x);
                return t.attr({
                    cy: L.bcy,
                    cx: L.bcx,
                    j: r,
                    ...
                    dataLabels: this.drawCalculatedDataLabels({
                        x: L.dataLabelsX,
                        y: L.dataLabelsY,
                        val: this.barCtx.isRangeBar ? [a, s] : h[o][r],
                        i: n,
                        j: r,
                        barWidth: d,
                        barHeight: c,
                    ...
                    totalDataLabels: p = f.config.chart.stacked && S.enabled ? this.drawTotalDataLabels({
            ...
            value: function(t) {
                ...
                return a = this.totalFormatter ? this.totalFormatter(a, T(T({}, i), {}, {
                    seriesIndex: e,
                    dataPointIndex: t,
                    w: i
                })) : a
            ...
            value: function(t) {
                var e, i, a = this.w,
                    ...
                    h = h - m / 2 + (-1 !== n ? n * c : 0),
                    t = a.globals.gridWidth / a.globals.dataPoints,
                    k = (this.barCtx.isVerticalGroupedRangeBar ? u += c / 2 : u = a.globals.isXNumeric ? h - c / 2 + y : h - t + c / 2 + y, w && (u = u + g.height / 2 - m / 2 - 2), this.barCtx.series[s][o] < 0),
                    A = l;
                switch (this.barCtx.isReversed && (A = l - d + (k ? 2 * d : 0), l -= d), x.position) {
                    case "center":
                        p = w ? k ? A + d / 2 + v : A + d / 2 - v : k ? A - d / 2 + g.height / 2 + v : A + d / 2 + g.height / 2 - v;
                        break;
                    case "bottom":
                        p = w ? k ? A + d + v : A + d - v : k ? A - d + g.height + m + v : A + d - g.height / 2 + m - v;
                        break;
                    case "top":
                        p = w ? k ? A + v : A - v : k ? A - g.height / 2 - v : A + g.height + v
                }
                return this.barCtx.lastActiveBarSerieIndex === r && b.enabled && (n = new Y(this.barCtx.ctx).getTextRects(this.getStackedTotalDataLabel({
                    realIndex: r,
                    j: o
                }), f.fontSize), e = k ? A - n.height / 2 - v - b.offsetY + 18 : A + n.height + v + b.offsetY - 18, i = u + b.offsetX), a.config.chart.stacked || (p < 0 ? p = 0 + m : p + g.height / 3 > a.globals.gridHeight && (p = a.globals.gridHeight - m)), {
                    bcx: h,
                    bcy: l,
                    dataLabelsX: u,
                    dataLabelsY: p,
            ...
            value: function(t) {
                var e, i, a = this.w,
                    ...
                    m = t.offX,
                    t = t.offY,
                    y = a.globals.gridHeight / a.globals.dataPoints,
                    d = Math.abs(d),
                    l = (h += -1 !== l ? l * c : 0) - (this.barCtx.isRangeBar ? 0 : y) + c / 2 + g.height / 2 + t - 3,
                    y = "start",
                    v = this.barCtx.series[o][r] < 0,
                    w = s;
                switch (this.barCtx.isReversed && (w = s + d - (v ? 2 * d : 0), s = a.globals.gridWidth - d), x.position) {
                    case "center":
                        u = v ? w + d / 2 - m : Math.max(g.width / 2, w - d / 2) + m;
                        break;
                    case "bottom":
                        u = v ? w + d - p - Math.round(g.width / 2) - m : w - d + p + Math.round(g.width / 2) + m;
                        break;
                    case "top":
                        u = v ? w - p + Math.round(g.width / 2) - m : w - p - Math.round(g.width / 2) + m
                }
                return this.barCtx.lastActiveBarSerieIndex === n && b.enabled && (c = new Y(this.barCtx.ctx).getTextRects(this.getStackedTotalDataLabel({
                    realIndex: n,
                    j: r
                }), f.fontSize), v ? (e = w - p + Math.round(c.width / 2) - m - b.offsetX - 15, y = "end") : e = w - p - Math.round(c.width / 2) + m + b.offsetX + 15, i = l + b.offsetY), a.config.chart.stacked || (u < 0 ? u = u + g.width + p : u + g.width / 2 > a.globals.gridWidth && (u = a.globals.gridWidth - g.width - p)), {
                    bcx: s,
                    bcy: h,
                    dataLabelsX: u,
                    dataLabelsY: l,
            ...
            value: function(t) {
                var e = t.x,
                    ...
                    h = this.w,
                    c = "rotate(0)",
                    d = ("vertical" === h.config.plotOptions.bar.dataLabels.orientation && (c = "rotate(-90, ".concat(e, ", ").concat(i, ")")), new k(this.barCtx.ctx)),
            ...
            value: function(t) {
                var e, i = t.x,
                    ...
                    n = new Y(this.barCtx.ctx);
                return e = t.enabled && void 0 !== i && void 0 !== a && this.barCtx.lastActiveBarSerieIndex === o ? n.drawText({
                    x: i,
                    y: a,
        ...
        Vt = (t(le, [{
            ...
            value: function(e, i, a, t) {
                ...
                return 0 < this.barCtx.barOptions.colors.ranges.length && this.barCtx.barOptions.colors.ranges.map(function(t) {
                    ...
                    fillType: null != (n = s.config.series[i].data[a]) && null != (t = n.fill) && t.type ? null == (o = s.config.series[i].data[a]) ? void 0 : o.fill.type : s.config.fill.type
                })
            }
        }, {
            key: "getStrokeWidth",
            value: function(t, e, i) {
                var a = 0,
                    s = this.w;
                return this.barCtx.series[t][e] ? this.barCtx.isNullValue = !1 : this.barCtx.isNullValue = !0, a = !s.config.stroke.show || this.barCtx.isNullValue ? a : Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[i] : this.barCtx.strokeWidth
            }
        }, {
            ...
            value: function(t) {
                var e = t.j,
                    ...
                    t = t.elSeries,
                    n = this.w,
                    l = new Y(this.barCtx.ctx),
                    h = new C(this.barCtx.ctx).getActiveConfigSeriesIndex();
            ...
            value: function(t) {
                var e = t.barWidth,
                    ...
                    d = e,
                    g = i,
                    u = (null != (u = t.config.series[n].data[h]) && u.columnWidthOffset && (g = i - t.config.series[n].data[h].columnWidthOffset / 2, d = e + t.config.series[n].data[h].columnWidthOffset), g),
                    i = g + d,
                    e = (s += .001, c.move(u, a += .001)),
                    g = c.move(u, a),
                    d = c.line(i - o, a);
            ...
            value: function(t) {
                var e = t.barYPosition,
                    ...
                    d = e,
                    g = i,
                    u = (null != (u = t.config.series[n].data[h]) && u.barHeightOffset && (d = e - t.config.series[n].data[h].barHeightOffset / 2, g = i + t.config.series[n].data[h].barHeightOffset), d),
                    e = d + g,
                    i = (s += .001, c.move(a += .001, u)),
                    d = c.move(a, u),
                    g = (0 < t.globals.previousPaths.length && (d = this.barCtx.getPreviousPath(n, h, !1)), c.line(a, e - o)),
                    i = i + c.line(s, u) + c.line(s, e - o) + g + ("around" === t.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z"),
                    d = d + c.line(a, u) + g + g + g + g + g + c.line(a, u) + ("around" === t.config.plotOptions.bar.borderRadiusApplication ? " Z" : " z");
                return this.shouldApplyRadius(n) && (i = c.roundPathCorners(i, t.config.plotOptions.bar.borderRadius)), t.config.chart.stacked && (e = this.barCtx, (e = t.globals.hasSeriesGroups && r ? this.barCtx[r] : e).xArrj.push(s), e.xArrjF.push(Math.abs(a - s)), e.xArrjVal.push(this.barCtx.series[l][h])), {
                    pathTo: i,
                    pathFrom: d
                }
            }
            ...
            key: "getGoalValues",
            value: function(a, s, o, t, e) {
                function i(t, e) {
                    var i;
                    c.push((M(i = {}, a, "x" === a ? l.getXForValue(t, s, !1) : l.getYForValue(t, o, !1)), M(i, "attrs", e), i))
                }
                var r, n, l = this,
                    h = this.w,
                    c = [];
                return h.globals.seriesGoals[t] && h.globals.seriesGoals[t][e] && Array.isArray(h.globals.seriesGoals[t][e]) && h.globals.seriesGoals[t][e].forEach(function(t) {
                    i(t.value, t)
                }), this.barCtx.barOptions.isDumbbell && h.globals.seriesRange.length && (r = this.barCtx.barOptions.dumbbellColors || h.globals.colors, n = {
                    strokeHeight: "x" === a ? 0 : h.globals.markers.size[t],
                    strokeWidth: "x" === a ? h.globals.markers.size[t] : 0,
                    strokeDashArray: 0,
                    strokeLineCap: "round",
                    strokeColor: Array.isArray(r[t]) ? r[t][0] : r[t]
                }, i(h.globals.seriesRangeStart[t][e], n), i(h.globals.seriesRangeEnd[t][e], T(T({}, n), {}, {
                    strokeColor: Array.isArray(r[t]) ? r[t][1] : r[t]
                }))), c
            }
        }, {
            key: "drawGoalLine",
        ...
        I = (t(ne, [{
            ...
            value: function(t, e) {
                ...
                for (var r = 0, n = 0; r < t.length; r++, n++) {
                    var l = void 0,
                        ...
                        p = (this.ctx.series.addCollapsedClassToSeries(u, g), 0 < t[r].length && (this.visibleI = this.visibleI + 1), 0),
                        f = 0,
                        ...
                        y = x.xDivision,
                        v = x.zeroH,
                        w = (this.horizontal || d.push(l + f / 2), a.group({
                            class: "apexcharts-datalabels",
                            "data:realIndex": g
                        })),
                        k = (i.globals.delayedElements.push({
                            el: w.node
                        }), w.node.classList.add("apexcharts-element-hidden"), a.group({
                    ...
                    for (var S = 0; S < i.globals.dataPoints; S++) {
                        var C = this.barHelpers.getStrokeWidth(r, S, g),
                            L = null,
                            P = {
                                indexes: {
                                    i: r,
                            ...
                            P = (this.isHorizontal ? (L = this.drawBarPaths(T(T({}, P), {}, {
                                barHeight: p,
                                zeroW: m,
                                yDivision: b
                            })), f = this.series[r][S] / this.invertedYRatio) : (L = this.drawColumnPaths(T(T({}, P), {}, {
                                xDivision: y,
                                barWidth: f,
                                zeroH: v
                            })), p = this.series[r][S] / this.yRatio[this.yaxisIndex]), this.barHelpers.getPathFillColor(t, r, S, g)),
                            I = (this.isFunnel && this.barOptions.isFunnel3d && this.pathArr.length && 0 < S && (I = this.barHelpers.drawBarShadow({
                                color: "string" == typeof P && -1 === (null == P ? void 0 : P.indexOf("url")) ? P : E.hexToRgba(i.globals.colors[r]),
                                prevPaths: this.pathArr[this.pathArr.length - 1],
                                currPaths: L
                            })) && A.add(I), this.pathArr.push(L), this.barHelpers.drawGoalLine({
                        ...
                        I && k.add(I), h = L.y, l = L.x, 0 < S && d.push(l + f / 2), c.push(h), this.renderSeries({
                            realIndex: g,
                            pathFill: P,
                            j: S,
                            i: r,
                            ...
                            y: h,
                            series: t,
                            barHeight: L.barHeight || p,
                            barWidth: L.barWidth || f,
                            elDataLabelsWrap: w,
                            elGoalsMarkers: k,
                            elBarShadows: A,
            ...
            value: function(t) {
                var e = t.realIndex,
                    ...
                    L = (S.config.series[o].data[s] && S.config.series[o].data[s].strokeColor && (a = S.config.series[o].data[s].strokeColor), this.isNullValue && (i = "none"), s / S.config.chart.animations.animateGradually.delay * (S.config.chart.animations.speed / S.globals.dataPoints) / 2.4),
                    C = C.renderPaths({
                        i: o,
                        j: s,
                        realIndex: e,
                    ...
                    n = (C.attr("clip-path", "url(#gridRectMask".concat(S.globals.cuid, ")")), S.config.forecastDataPoints),
                    l = (0 < n.count && s >= S.globals.dataPoints - n.count && (C.node.setAttribute("stroke-dasharray", n.dashArray), C.node.setAttribute("stroke-width", n.strokeWidth), C.node.setAttribute("fill-opacity", n.fillOpacity)), void 0 !== u && void 0 !== p && (C.attr("data-range-y1", u), C.attr("data-range-y2", p)), new P(this.ctx).setSelectionFilter(C, e, s), c.add(C), new Gt(this).handleBarDataLabels({
                        x: d,
                        y: g,
                        y1: u,
                        y2: p,
                ...
                return null !== l.dataLabels && v.add(l.dataLabels), l.totalDataLabels && v.add(l.totalDataLabels), c.add(v), w && c.add(w), k && c.add(k), c
            }
        }, {
            key: "drawBarPaths",
            value: function(t) {
            ...
            value: function(t) {
                var e, i, a, s = t.indexes,
                    ...
                    u = s.j,
                    p = s.bc,
                    s = (c.globals.isXNumeric ? (c.globals.seriesX[d = d].length || (d = c.globals.maxValsInArrayIndex), e = (o = c.globals.seriesX[d][u] ? (c.globals.seriesX[d][u] - c.globals.minX) / this.xRatio - n * this.seriesLen / 2 : o) + n * this.visibleI) : c.config.plotOptions.bar.hideZeroBarsWhenGrouped ? (a = i = 0, c.globals.seriesPercent.forEach(function(t, e) {
                        t[u] && i++, e < g && 0 === t[u] && a++
                    }), e = o + (n = 0 < i ? this.seriesLen * n / i : n) * this.visibleI, e -= n * a) : e = o + n * this.visibleI, d = this.barHelpers.getYForValue(this.series[g][u], l), this.barHelpers.getColumnPaths({
                        barXPosition: e,
                        barWidth: n,
                        y1: l,
                        y2: d,
                ...
                return c.globals.isXNumeric || (o += r), this.barHelpers.barBackground({
                    ...
                    x: o,
                    y: d,
                    goalY: this.barHelpers.getGoalValues("y", null, l, g, u),
                    barXPosition: e,
                    barWidth: n
                }
            }
        ...
        jt = (e(h, I), lt = i(h), t(h, [{
            ...
            value: function(v, w) {
                var k = this,
                    A = this.w,
                    t = (this.graphics = new Y(this.ctx), this.bar = new I(this.ctx, this.xyRatios), new z(this.ctx, A));
                v = t.getLogSeries(v), this.yRatio = t.getLogYRatios(this.yRatio), this.barHelpers.initVariables(v), "100%" === A.config.chart.stackType && (v = A.globals.seriesPercent.slice()), this.series = v, this.barHelpers.initializeStackedPrevVars(this);
                for (var S = this.graphics.group({
                        class: "apexcharts-bar-series apexcharts-plot-series"
                    }), C = 0, L = 0, e = 0, i = 0; e < v.length; e++, i++) ! function(i, t) {
                    var e, a, s, o, r = -1,
                        n = (k.groupCtx = k, A.globals.seriesGroups.forEach(function(t, e) {
                            -1 < t.indexOf(A.config.series[i].name) && (r = e)
                        }), -1 !== r && (k.groupCtx = k[A.globals.seriesGroups[r]]), []),
                        l = [],
                        h = A.globals.comboCharts ? w[i] : i,
                        c = (1 < k.yRatio.length && (k.yaxisIndex = h), k.isReversed = A.config.yaxis[k.yaxisIndex] && A.config.yaxis[k.yaxisIndex].reversed, k.graphics.group({
                            class: "apexcharts-series",
                            seriesName: E.escapeString(A.globals.seriesNames[h]),
                            rel: i + 1,
                            "data:realIndex": h
                        })),
                        d = (k.ctx.series.addCollapsedClassToSeries(c, h), k.graphics.group({
                            class: "apexcharts-datalabels",
                            "data:realIndex": h
                        })),
                        g = k.graphics.group({
                        ...
                        u = 0,
                        p = 0,
                        f = k.initialPositions(C, L, void 0, void 0, void 0, void 0);
                    L = f.y, u = f.barHeight, a = f.yDivision, o = f.zeroW, C = f.x, p = f.barWidth, e = f.xDivision, s = f.zeroH, k.barHelpers.initializeStackedXYVars(k), 1 === k.groupCtx.prevY.length && k.groupCtx.prevY[0].every(function(t) {
                        return isNaN(t)
                    ...
                    for (var x = 0; x < A.globals.dataPoints; x++) var b = k.barHelpers.getStrokeWidth(i, x, h),
                        m = {
                            indexes: {
                                i: i,
                                j: x,
                            ...
                            elSeries: c,
                            groupIndex: r,
                            seriesGroup: A.globals.seriesGroups[r]
                        },
                        y = null,
                        m = (k.isHorizontal ? (y = k.drawStackedBarPaths(T(T({}, m), {}, {
                            zeroW: o,
                            barHeight: u,
                            yDivision: a
                        })), p = k.series[i][x] / k.invertedYRatio) : (y = k.drawStackedColumnPaths(T(T({}, m), {}, {
                            xDivision: e,
                            barWidth: p,
                            zeroH: s
                        })), u = k.series[i][x] / k.yRatio[k.yaxisIndex]), k.barHelpers.drawGoalLine({
                            barXPosition: y.barXPosition,
                            barYPosition: y.barYPosition,
                            goalX: y.goalX,
                            goalY: y.goalY,
                            barHeight: u,
                            barWidth: p
                        })),
                        m = (m && g.add(m), L = y.y, C = y.x, n.push(C), l.push(L), k.barHelpers.getPathFillColor(v, i, x, h)),
                        c = k.renderSeries({
                            realIndex: h,
                            pathFill: m,
                            j: x,
                    ...
                    A.globals.seriesXvalues[h] = n, A.globals.seriesYvalues[h] = l, k.groupCtx.prevY.push(k.groupCtx.yArrj), k.groupCtx.prevYF.push(k.groupCtx.yArrjF), k.groupCtx.prevYVal.push(k.groupCtx.yArrjVal), k.groupCtx.prevX.push(k.groupCtx.xArrj), k.groupCtx.prevXF.push(k.groupCtx.xArrjF), k.groupCtx.prevXVal.push(k.groupCtx.xArrjVal), S.add(c)
                }(e, i);
                return S
            }
        }, {
            ...
            value: function(t, e, i, a, s, o) {
                var r, n, l = this.w;
                return this.isHorizontal ? (r = (r = a = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight, 10) / 100, -1 === String(l.config.plotOptions.bar.barHeight).indexOf("%") && (r = parseInt(l.config.plotOptions.bar.barHeight, 10)), o = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0), e = (a - r) / 2) : (n = i = l.globals.gridWidth / l.globals.dataPoints, n = l.globals.isXNumeric && 1 < l.globals.dataPoints ? (i = l.globals.minXDiff / this.xRatio) * parseInt(this.barOptions.columnWidth, 10) / 100 : n * parseInt(l.config.plotOptions.bar.columnWidth, 10) / 100, -1 === String(l.config.plotOptions.bar.columnWidth).indexOf("%") && (n = parseInt(l.config.plotOptions.bar.columnWidth, 10)), s = l.globals.gridHeight - this.baseLineY[this.yaxisIndex] - (this.isReversed ? l.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), t = l.globals.padHorizontal + (i - n) / 2), {
                    x: t,
                    y: e,
                    yDivision: a,
                    xDivision: i,
                    barHeight: null != (t = l.globals.seriesGroups) && t.length ? r / l.globals.seriesGroups.length : r,
                    barWidth: null != (e = l.globals.seriesGroups) && e.length ? n / l.globals.seriesGroups.length : n,
                    zeroH: s,
                    zeroW: o
                }
            }
            ...
            value: function(t) {
                for (var e = t.indexes, i = t.barHeight, a = t.strokeWidth, s = t.zeroW, o = (t.x, t.y), r = t.groupIndex, n = t.seriesGroup, l = t.yDivision, t = t.elSeries, h = this.w, r = o + (-1 !== r ? r * i : 0), c = e.i, d = e.j, g = 0, u = 0; u < this.groupCtx.prevXF.length; u++) g += this.groupCtx.prevXF[u][d];
                var p = c,
                    p = 0 < (p = n ? n.indexOf(h.config.series[c].name) : p) ? (f = s, this.groupCtx.prevXVal[p - 1][d] < 0 ? f = 0 <= this.series[c][d] ? this.groupCtx.prevX[p - 1][d] + g - 2 * (this.isReversed ? g : 0) : this.groupCtx.prevX[p - 1][d] : 0 <= this.groupCtx.prevXVal[p - 1][d] && (f = 0 <= this.series[c][d] ? this.groupCtx.prevX[p - 1][d] : this.groupCtx.prevX[p - 1][d] - g + 2 * (this.isReversed ? g : 0)), f) : s,
                    f = null === this.series[c][d] ? p : p + this.series[c][d] / this.invertedYRatio - 2 * (this.isReversed ? this.series[c][d] / this.invertedYRatio : 0),
            ...
            value: function(t) {
                for (var e = t.indexes, i = t.x, a = (t.y, t.xDivision), s = t.barWidth, o = t.zeroH, r = t.groupIndex, n = t.seriesGroup, t = t.elSeries, l = this.w, h = e.i, c = e.j, d = e.bc, g = (i = l.globals.isXNumeric && (i = ((g = (g = l.globals.seriesX[h][c]) || 0) - l.globals.minX) / this.xRatio - s / 2, l.globals.seriesGroups.length) ? (g - l.globals.minX) / this.xRatio - s / 2 * l.globals.seriesGroups.length : i) + (-1 !== r ? r * s : 0), u = 0, p = 0; p < this.groupCtx.prevYF.length; p++) u += isNaN(this.groupCtx.prevYF[p][c]) ? 0 : this.groupCtx.prevYF[p][c];
                var f = h;
                if (0 < (f = n ? n.indexOf(l.config.series[h].name) : f) && !l.globals.isXNumeric || 0 < f && l.globals.isXNumeric && l.globals.seriesX[h - 1][c] === l.globals.seriesX[h][c]) {
                    var x, b, m, y = Math.min(this.yRatio.length + 1, h + 1);
                    if (void 0 !== this.groupCtx.prevY[f - 1] && this.groupCtx.prevY[f - 1].length)
                        for (var v = 1; v < y; v++)
                            if (!isNaN(null == (m = this.groupCtx.prevY[f - v]) ? void 0 : m[c])) {
                                b = this.groupCtx.prevY[f - v][c];
                                break
                            }
                    for (var w, k = 1; k < y; k++) {
                        if ((null == (w = this.groupCtx.prevYVal[f - k]) ? void 0 : w[c]) < 0) {
                            x = 0 <= this.series[h][c] ? b - u + 2 * (this.isReversed ? u : 0) : b;
                            break
                        }
                        if (0 <= (null == (w = this.groupCtx.prevYVal[f - k]) ? void 0 : w[c])) {
                            x = 0 <= this.series[h][c] ? b : b + u - 2 * (this.isReversed ? u : 0);
                            break
                        }
                    }
                    void 0 === x && (x = l.globals.gridHeight), A = null != (r = this.groupCtx.prevYF[0]) && r.every(function(t) {
                        return 0 === t
                ...
                var r = this.series[h][c] ? A - this.series[h][c] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[h][c] / this.yRatio[this.yaxisIndex] : 0) : A,
        ...
        _t = (e(l, I), nt = i(l), t(l, [{
            ...
            value: function(m, t, s) {
                var y = this,
                    v = this.w,
                    o = new Y(this.ctx),
                    t = v.globals.comboCharts ? t : v.config.chart.type,
                    w = new S(this.ctx),
                    e = (this.candlestickOptions = this.w.config.plotOptions.candlestick, this.boxOptions = this.w.config.plotOptions.boxPlot, this.isHorizontal = v.config.plotOptions.bar.horizontal, new z(this.ctx, v));
                m = e.getLogSeries(m), this.series = m, this.yRatio = e.getLogYRatios(this.yRatio), this.barHelpers.initVariables(m);
                for (var k = o.group({
                        class: "apexcharts-".concat(t, "-series apexcharts-plot-series")
                    }), i = 0; i < m.length; i++) ! function(r) {
                    y.isBoxPlot = "boxPlot" === v.config.chart.type || "boxPlot" === v.config.series[r].type;
                    var n = void 0,
                        l = void 0,
                        e = [],
                        i = [],
                        ...
                        c = o.group({
                            class: "apexcharts-series",
                            seriesName: E.escapeString(v.globals.seriesNames[h]),
                            rel: r + 1,
                            "data:realIndex": h
                        }),
                        t = (y.ctx.series.addCollapsedClassToSeries(c, h), 0 < m[r].length && (y.visibleI = y.visibleI + 1), 1 < y.yRatio.length && (y.yaxisIndex = h), y.barHelpers.initialPositions()),
                        l = t.y,
                        d = t.barHeight,
                        g = t.yDivision,
                        u = t.zeroW,
                    ...
                    for (var b = o.group({
                            class: "apexcharts-datalabels",
                            "data:realIndex": h
                        }), a = 0; a < v.globals.dataPoints; a++) ! function(a) {
                        var s = y.barHelpers.getStrokeWidth(r, a, h),
                            ...
                            o = y.isHorizontal ? y.drawHorizontalBoxPaths(T(T({}, t), {}, {
                                yDivision: g,
                                barHeight: d,
                                zeroW: u
                            })) : y.drawVerticalBoxPaths(T(T({}, t), {}, {
                                xDivision: f,
                                barWidth: p,
                                zeroH: x
                            }));
                        l = o.y, n = o.x, 0 < a && i.push(n + p / 2), e.push(l), o.pathTo.forEach(function(t, e) {
                            var i = !y.isBoxPlot && y.candlestickOptions.wick.useFillColor ? o.color[e] : v.globals.stroke.colors[r],
                                e = w.fillPath({
                                    seriesNumber: h,
                                    dataPointIndex: a,
                                    color: o.color[e],
            ...
            value: function(t) {
                var e = t.indexes,
                    ...
                    l = (void 0 === this.series[l][h] || null === this.series[l][h] ? y = m = o : (m = o - m / p, y = o - y / p, x = o - f.h / p, b = o - f.l / p, v = o - f.m / p), n.move(w, o), n.move(w + s / 2, m));
                return 0 < r.globals.previousPaths.length && (l = this.getPreviousPath(e, h, !0)), f = this.isBoxPlot ? [n.move(w, m) + n.line(w + s / 2, m) + n.line(w + s / 2, x) + n.line(w + s / 4, x) + n.line(w + s - s / 4, x) + n.line(w + s / 2, x) + n.line(w + s / 2, m) + n.line(w + s, m) + n.line(w + s, v) + n.line(w, v) + n.line(w, m + t / 2), n.move(w, v) + n.line(w + s, v) + n.line(w + s, y) + n.line(w + s / 2, y) + n.line(w + s / 2, b) + n.line(w + s - s / 4, b) + n.line(w + s / 4, b) + n.line(w + s / 2, b) + n.line(w + s / 2, y) + n.line(w, y) + n.line(w, v) + "z"] : [n.move(w, y) + n.line(w + s / 2, y) + n.line(w + s / 2, x) + n.line(w + s / 2, y) + n.line(w + s, y) + n.line(w + s, m) + n.line(w + s / 2, m) + n.line(w + s / 2, b) + n.line(w + s / 2, m) + n.line(w, m) + n.line(w, y - t / 2)], l += n.move(w, m), r.globals.isXNumeric || (i += a), {
                    pathTo: f,
                    pathFrom: l,
                    x: i,
                    y: y,
        ...
        Ut = (t(re, [{
            ...
            value: function(t, e, i, a) {
                var s = this.w,
                    ...
                    a = new E;
                return {
                    color: i = s.config.plotOptions[t].enableShades ? "dark" === this.w.config.theme.mode ? E.hexToRgba(a.shadeColor(-1 * o, e.color), s.config.fill.opacity) : E.hexToRgba(a.shadeColor(o, e.color), s.config.fill.opacity) : i,
                    colorProps: e
                }
            }
        }, {
            ...
            value: function(t, e, i) {
                var a = this.w,
                    ...
                    l = null,
                    h = Math.min.apply(Math, m(a.globals.series[e])),
                    c = Math.max.apply(Math, m(a.globals.series[e])),
        ...
        qt = (t(oe, [{
            ...
            value: function(t) {
                ...
                for (var h = n ? 0 : l.length - 1; n ? h < l.length : 0 <= h; n ? h++ : h--) {
                    ...
                    this.ctx.series.addCollapsedClassToSeries(d, h), e.config.chart.dropShadow.enabled && (c = e.config.chart.dropShadow, new P(this.ctx).dropShadow(d, c, h));
                    for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                        var f, x = this.helpers.getShadeColor(e.config.chart.type, h, p, this.negRange),
                            b = x.color,
                            x = x.colorProps,
                            m = ("image" === e.config.fill.type && (b = new S(this.ctx).fillPath({
                                seriesNumber: h,
                                dataPointIndex: p,
                            ...
                            m = (m.attr({
                                ...
                                color: b
                            }), this.helpers.addListeners(m), e.config.chart.animations.enabled && !e.globals.dataChanged && (f = 1, e.globals.resized || (f = e.config.chart.animations.speed), this.animateHeatMap(m, g, r, s, o, f)), e.globals.dataChanged && (f = 1, this.dynamicAnim.enabled) && e.globals.shouldAnimate && (f = this.dynamicAnim.speed, y = (y = e.globals.previousPaths[h] && e.globals.previousPaths[h][p] && e.globals.previousPaths[h][p].color) || "rgba(255, 255, 255, 0)", this.animateHeatColor(m, E.isColorHex(y) ? y : E.rgb2hex(y), E.isColorHex(b) ? b : E.rgb2hex(b), f)), (0, e.config.dataLabels.formatter)(e.globals.series[h][p], {
        ...
        $t = (t(ae, [{
            ...
            value: function(t) {
                ...
                if (this.ret = a.group({
                    ...
                    for (var s = 0, o = 0; o < t.length; o++) s += E.negToZero(t[o]);
                    var r = [],
                        n = a.group();
                    ...
                    var p = i.config.plotOptions.pie.customScale,
                        ...
                        b = ("donut" === this.chartType && ((a = a.drawCircle(this.donutSize)).attr({
                            cx: this.centerX,
                            cy: this.centerY,
                            fill: i.config.plotOptions.pie.donut.background || "transparent"
                        }), n.add(a)), this.drawArcs(r, t));
                    this.sliceLabels.forEach(function(t) {
                        b.add(t)
                    }), n.attr({
                        transform: "translate(".concat(f, ", ").concat(x, ") scale(").concat(p, ")")
                    }), n.add(b), this.ret.add(n), this.donutDataLabels.show && (a = this.renderInnerDataLabels(this.donutDataLabels, {
                        ...
                        translateX: f,
                        translateY: x
                    }), this.ret.add(a)), "front" === i.config.grid.position && "polarArea" === this.chartType && this.drawPolarElements(this.ret)
                }
                return this.ret
            }
        }, {
            ...
            value: function(t, e) {
                ...
                for (var h = 0; h < t.length; h++) {
                    var c, d, g = s.group({
                            ...
                            seriesName: E.escapeString(i.globals.seriesNames[h]),
                            rel: h + 1,
                            "data:realIndex": h
                        }),
                        ...
                        p = (f.attr({
                            index: 0,
                            j: h
                        }), a.setSelectionFilter(f, 0, h), i.config.chart.dropShadow.enabled && (p = i.config.chart.dropShadow, a.dropShadow(f, p, h)), this.addListeners(f, this.donutDataLabels), Y.setAttrs(f.node, {
                            "data:angle": u,
                            "data:startAngle": c,
                        ...
                        g = ("pie" === this.chartType || "polarArea" === this.chartType ? p = E.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, (c + u / 2) % this.fullAngle) : "donut" === this.chartType && (p = E.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (c + u / 2) % this.fullAngle)), g.add(f), 0);
                    !this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 == (g = u / this.fullAngle * i.config.chart.animations.speed) && (g = 1), this.animDur = g + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(f, {
                        ...
                        animBeginArr: this.animBeginArr,
                        dur: g
                    }), i.config.plotOptions.pie.expandOnClick && "polarArea" !== this.chartType && f.click(this.pieClicked.bind(this, h)), void 0 !== i.globals.selectedDataPoints[0] && -1 < i.globals.selectedDataPoints[0].indexOf(h) && this.pieClicked(h), i.config.dataLabels.enabled && (d = p.x, c = p.y, g = 100 * u / this.fullAngle + "%", 0 != u) && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[h] && (void 0 !== (f = i.config.dataLabels.formatter) && (g = f(i.globals.seriesPercent[h][0], {
                        seriesIndex: h,
                        w: i
            ...
            value: function(t) {
                ...
                }), this.revertDataLabelsInner(t.node, this.donutDataLabels), a = t.attr("data:pathOrig"), t.attr({
                    d: a
                }))
            }
        }, {
            ...
            value: function(t) {
                var e = t.me,
                    ...
                    o = Math.PI * (s - 90) / 180,
                    i = a + i,
                    r = (Math.ceil(i) >= this.fullAngle + this.w.config.plotOptions.pie.startAngle % this.fullAngle && (i = this.fullAngle + this.w.config.plotOptions.pie.startAngle % this.fullAngle - .01), Math.ceil(i) > this.fullAngle && (i -= this.fullAngle), Math.PI * (i - 90) / 180),
                    n = e.centerX + t * Math.cos(o),
                    o = e.centerY + t * Math.sin(o),
                    l = e.centerX + t * Math.cos(r),
                    r = e.centerY + t * Math.sin(r),
                    i = E.polarToCartesian(e.centerX, e.centerY, e.donutSize, i),
                    s = E.polarToCartesian(e.centerX, e.centerY, e.donutSize, s),
                    a = 180 < a ? 1 : 0,
                    t = ["M", n, o, "A", t, t, 0, a, 1, l, r];
                return ("donut" === e.chartType ? [].concat(t, ["L", i.x, i.y, "A", e.donutSize, e.donutSize, 0, a, 0, s.x, s.y, "L", n, o, "z"]) : "pie" === e.chartType || "polarArea" === e.chartType ? [].concat(t, ["L", e.centerX, e.centerY, "L", n, o]) : [].concat(t)).join(" ")
            }
        }, {
            ...
            value: function(t, e) {
                ...
                var r = e.centerX,
                    ...
                    u = "",
                    p = "";
                return o ? (n = t.total.color, l = t.total.fontSize, h = t.total.fontFamily, c = t.total.fontWeight, p = t.total.label, u = t.total.formatter(i)) : 1 === i.globals.series.length && (u = g(i.globals.series[0], i), p = i.globals.seriesNames[0]), p = p && t.name.formatter(p, t.total.show, i), t.name.show && ((o = a.drawText({
                    x: r,
                    ...
                    fontWeight: c,
                    fontFamily: h
                })).node.classList.add("apexcharts-datalabel-label"), s.add(o)), t.value.show && (g = t.name.show ? parseFloat(t.value.offsetY) + 16 : t.value.offsetY, (i = a.drawText({
                    x: r,
                    y: e + g,
                    text: u,
                    textAnchor: "middle",
                ...
                })).node.classList.add("apexcharts-datalabel-value"), s.add(i)), s
            }
        }, {
            ...
            value: function(i) {
                ...
                if (0 !== o.strokeWidth) {
                    for (var e = [], r = 360 / t.globals.series.length, n = 0; n < t.globals.series.length; n++) e.push(E.polarToCartesian(this.centerX, this.centerY, t.globals.radialSize, t.config.plotOptions.pie.startAngle + r * n));
        ...
        Jt = (t(ie, [{
                ...
                return this.yaxisLabels = this.graphics.group({
                    ...
                    var e = t.length === p.globals.dataPoints,
                        o = u.graphics.group().attr({
                            ...
                            seriesName: E.escapeString(p.globals.seriesNames[s]),
                            rel: s + 1,
                            "data:realIndex": s
                        }),
                        i = (u.dataRadiusOfPercent[s] = [], u.dataRadius[s] = [], u.angleArr[s] = [], t.forEach(function(t, e) {
                            var i = Math.abs(u.maxValue - u.minValue);
                            t += Math.abs(u.minValue), u.isLog && (t = u.coreUtils.getLogVal(t, 0)), u.dataRadiusOfPercent[s][e] = t / i, u.dataRadius[s][e] = u.dataRadiusOfPercent[s][e] * u.size, u.angleArr[s][e] = e * u.disAngle
                    ...
                    for (var n = 0; n < i.linePathsTo.length; n++) {
                        var l, h, c = u.graphics.renderPaths(T(T({}, a), {}, {
                            ...
                            c = u.graphics.renderPaths(T(T({}, a), {}, {
                        ...
                        p.config.chart.dropShadow.enabled && (l = new P(u.ctx), h = p.config.chart.dropShadow, l.dropShadow(c, Object.assign({}, h, {
                            noUserSpaceOnUse: !0
                        }), s)), o.add(c)
                    }
                    t.forEach(function(t, e) {
            ...
            key: "drawPolygons",
            value: function(t) {
                for (var o = this, s = this.w, r = t.parent, i = new Zt(this.ctx), a = s.globals.yAxisScale[0].result.reverse(), e = a.length, n = [], l = this.size / (e - 1), h = 0; h < e; h++) n[h] = l * h;
                n.reverse();
                var c = [],
                    d = [];
                n.forEach(function(t, a) {
                    var t = E.getPolygonPos(t, o.dataPointsLen),
                        s = "";
                    t.forEach(function(t, e) {
                        var i;
        ...
        Qt = (e(r, $t), rt = i(r), t(r, [{
            ...
            key: "drawArcs",
            value: function(t) {
                for (var e = this.w, i = new Y(this.ctx), a = new S(this.ctx), s = new P(this.ctx), o = i.group(), r = this.getStrokeWidth(t), n = (t.size = t.size - r / 2, e.config.plotOptions.radialBar.hollow.background), l = t.size - r * t.series.length - this.margin * t.series.length - r * parseInt(e.config.plotOptions.radialBar.track.strokeWidth, 10) / 100 / 2, h = l - e.config.plotOptions.radialBar.hollow.margin, h = (void 0 !== e.config.plotOptions.radialBar.hollow.image && (n = this.drawHollowImage(t, o, l, n)), this.drawHollow({
                        size: h,
                        centerX: t.centerX,
                        centerY: t.centerY,
                        fill: n || "transparent"
                    })), n = (e.config.plotOptions.radialBar.hollow.dropShadow.enabled && (n = e.config.plotOptions.radialBar.hollow.dropShadow, s.dropShadow(h, n)), 1), c = (!this.radialDataLabels.total.show && 1 < e.globals.series.length && (n = 0), null), d = (this.radialDataLabels.show && (c = this.renderInnerDataLabels(this.radialDataLabels, {
                        hollowSize: l,
                        centerX: t.centerX,
                        centerY: t.centerY,
                        opacity: n
                    })), "back" === e.config.plotOptions.radialBar.hollow.position && (o.add(h), c) && o.add(c), !1), g = (d = e.config.plotOptions.radialBar.inverseOrder ? !0 : d) ? t.series.length - 1 : 0; d ? 0 <= g : g < t.series.length; d ? g-- : g++) {
                    var u = i.group({
                            class: "apexcharts-series apexcharts-radial-series",
                            seriesName: E.escapeString(e.globals.seriesNames[g])
                        }),
                        p = (o.add(u), u.attr({
                            rel: g + 1,
                            "data:realIndex": g
                        }), this.ctx.series.addCollapsedClassToSeries(u, g), t.size = t.size - r - this.margin, a.fillPath({
                            seriesNumber: g,
                            size: t.size,
                            value: t.series[g]
                        })),
                        f = this.startAngle,
                        x = void 0,
                        b = E.negToZero(100 < t.series[g] ? 100 : t.series[g]) / 100,
                        b = Math.round(this.totalAngle * b) + this.startAngle,
                        m = void 0,
                        y = (e.globals.dataChanged && (x = this.startAngle, m = Math.round(this.totalAngle * E.negToZero(e.globals.previousPaths[g]) / 100) + x), 360 <= Math.abs(b) + Math.abs(f) && (b -= .01), 360 <= Math.abs(m) + Math.abs(x) && (m -= .01), b - f),
                        ...
                        }), e.config.chart.dropShadow.enabled && (v = e.config.chart.dropShadow, s.dropShadow(p, v, g)), s.setSelectionFilter(p, 0, g), this.addListeners(p, this.radialDataLabels), u.add(p), p.attr({
                            index: 0,
                            j: g
                        }), 0);
                    !this.initialAnim || e.globals.resized || e.globals.dataChanged || (y = e.config.chart.animations.speed), e.globals.dataChanged && (y = e.config.chart.animations.dynamicAnimation.speed), this.animDur = y / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur), this.animatePaths(p, {
                        centerX: t.centerX,
                        centerY: t.centerY,
                        endAngle: b,
                        startAngle: f,
        ...
        Kt = (e(s, I), ot = i(s), t(s, [{
            ...
            value: function(t, e) {
                ...
                for (var s = a.group({
                    ...
                    var r = void 0,
                        ...
                        h = a.group({
                            class: "apexcharts-series",
                            seriesName: E.escapeString(i.globals.seriesNames[l]),
                            rel: o + 1,
                            "data:realIndex": l
                        }),
                        ...
                        u = g.zeroW,
                        r = g.x;
                    d = g.barWidth, c = g.barHeight;
                    for (var p = g.xDivision, f = g.yDivision, x = g.zeroH, b = a.group({
                            class: "apexcharts-datalabels",
                            "data:realIndex": l
                        }), m = a.group({
                            class: "apexcharts-rangebar-goals-markers"
                        }), y = 0; y < i.globals.dataPoints; y++) {
                        var v, w = this.barHelpers.getStrokeWidth(o, y, l),
                            k = this.seriesRangeStart[o][y],
                            A = this.seriesRangeEnd[o][y],
                            S = null,
                            C = null,
                            L = null,
                            P = {
                            ...
                            I = this.seriesLen;
                        if (i.config.plotOptions.bar.rangeBarGroupRows && (I = 1), void 0 === i.config.series[o].data[y]) break;
                        this.isHorizontal ? (L = n + c * this.visibleI, i.config.series[o].data[y].x && (c = (v = this.detectOverlappingBars({
                            i: o,
                            j: y,
                            barYPosition: L,
                            srty: (f - c * I) / 2,
                            ...
                            yDivision: f,
                            initPositions: g
                        })).barHeight, L = v.barYPosition), d = (S = this.drawRangeBarPaths(T({
                            indexes: {
                                i: o,
                                j: y,
                                realIndex: l
                            ...
                            y1: k,
                            y2: A
                        }, P))).barWidth) : (C = (r = i.globals.isXNumeric ? (i.globals.seriesX[o][y] - i.globals.minX) / this.xRatio - d / 2 : r) + d * this.visibleI, i.config.series[o].data[y].x && (d = (v = this.detectOverlappingBars({
                            i: o,
                            j: y,
                            barXPosition: C,
                            srtx: (p - d * I) / 2,
                            ...
                            xDivision: p,
                            initPositions: g
                        })).barWidth, C = v.barXPosition), c = (S = this.drawRangeColumnPaths(T({
                            indexes: {
                                i: o,
                                j: y,
                                realIndex: l
                        ...
                        var I = this.barHelpers.drawGoalLine({
                            ...
                            P = (I && m.add(I), n = S.y, r = S.x, this.barHelpers.getPathFillColor(t, o, y, l)),
                            I = i.globals.stroke.colors[l];
                        this.renderSeries((M(P = {
                            realIndex: l,
                            pathFill: P,
                            lineFill: I,
                            j: y,
                            ...
                            barXPosition: C,
                            barYPosition: L
                        }, "barWidth", d), M(P, "elDataLabelsWrap", b), M(P, "elGoalsMarkers", m), M(P, "visibleSeries", this.visibleI), M(P, "type", "rangebar"), P))
                    }
                    s.add(h)
                }
                return s
            ...
            value: function(t) {
                var e = t.indexes,
                    ...
                    h = (void 0 === this.series[n][l] || null === this.series[n][l] ? g = t : (g = t - g / h, d = t - d / h), Math.abs(d - g)),
                ...
                return r.globals.isXNumeric || (i += a), {
                    ...
                    x: i,
                    y: d,
                    goalY: this.barHelpers.getGoalValues("y", null, t, n, l),
                    barXPosition: o
                }
            }
        }, {
        ...
        te = (t(ee, [{
            ...
            value: function(t, e) {
                var i = this.w;
                return "gradient" !== i.config.fill.type && "gradient" !== i.config.fill.type[t] || !new z(this.lineCtx.ctx, i).seriesHaveSameValues(t) || ((i = e[t].slice())[i.length - 1] = i[i.length - 1] + 1e-6, e[t] = i), e
            }
        }, {
            key: "calculatePoints",
            value: function(t) {
            ...
            value: function(t) {
                var e, i = t.i,
                    ...
                    o = t.lineYPosition,
                    t = this.w;
                if (void 0 !== (null == (e = a[i]) ? void 0 : e[0])) s = (o = t.config.chart.stacked && 0 < i ? this.lineCtx.prevSeriesY[i - 1][0] : this.lineCtx.zeroY) - a[i][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] + 2 * (this.lineCtx.isReversed ? a[i][0] / this.lineCtx.yRatio[this.lineCtx.yaxisIndex] : 0);
    ...
    function ee(t) {
        a(this, ee), this.w = t.w, this.lineCtx = t
    }

    function s() {
        return a(this, s), ot.apply(this, arguments)
    }

    function r(t) {
        a(this, r), (e = rt.call(this, t)).ctx = t, e.w = t.w, e.animBeginArr = [0], e.animDur = 0;
        var e, t = e.w;
    ...
    function oe(t, e) {
        a(this, oe), this.ctx = t, this.w = t.w, this.xRatio = e.xRatio, this.yRatio = e.yRatio, this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.helpers = new Ut(t), this.rectRadius = this.w.config.plotOptions.heatmap.radius, this.strokeWidth = this.w.config.stroke.show ? this.w.config.stroke.width : 0
    }
    ...
    function l() {
        return a(this, l), nt.apply(this, arguments)
    }

    function h() {
        return a(this, h), lt.apply(this, arguments)
    }

    function ne(t, e) {
        a(this, ne), this.ctx = t, this.w = t.w;
        var t = this.w,
            t = (this.barOptions = t.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = t.config.stroke.width, this.isNullValue = !1, this.isRangeBar = t.globals.seriesRange.length && this.isHorizontal, this.isVerticalGroupedRangeBar = !t.globals.isBarHorizontal && t.globals.seriesRange.length && t.config.plotOptions.bar.rangeBarGroupRows, this.isFunnel = this.barOptions.isFunnel, this.xyRatios = e, null !== this.xyRatios && (this.xRatio = e.xRatio, this.initialXRatio = e.initialXRatio, this.yRatio = e.yRatio, this.invertedXRatio = e.invertedXRatio, this.invertedYRatio = e.invertedYRatio, this.baseLineY = e.baseLineY, this.baseLineInvertedY = e.baseLineInvertedY), this.yaxisIndex = 0, this.seriesLen = 0, this.pathArr = [], new C(this.ctx)),
        ...
        this.stackedSeriesTotals = e.getStackedSeriesTotals(this.w.config.series.map(function(t, e) {
            ...
            return -1 !== t
        })), this.barHelpers = new Vt(this)
    }

    function le(t) {
        a(this, le), this.w = t.w, this.barCtx = t
    }

    function he(t) {
        a(this, he), this.w = t.w, this.barCtx = t, this.totalFormatter = this.w.config.plotOptions.bar.dataLabels.total.formatter, this.totalFormatter || (this.totalFormatter = this.w.config.dataLabels.formatter)
    }

    function ce(t) {
        a(this, ce), this.ctx = t, this.w = t.w;
        t = this.w;
        this.tConfig = t.config.tooltip, this.tooltipUtil = new Rt(this), this.tooltipLabels = new Dt(this), this.tooltipPosition = new Ht(this), this.marker = new Ot(this), this.intersect = new Nt(this), this.axesTooltip = new Wt(this), this.showOnIntersect = this.tConfig.intersect, this.showTooltipTitle = this.tConfig.x.show, this.fixedTooltip = this.tConfig.fixed.enabled, this.xaxisTooltip = null, this.yaxisTTEls = null, this.isBarShared = !t.globals.isBarHorizontal && this.tConfig.shared, this.lastHoverTime = Date.now()
    }
    ...
    function ue(t) {
        a(this, ue), this.w = t.w, this.ttCtx = t, this.ctx = t.ctx, this.tooltipPosition = new Ht(t)
    }

    function pe(t) {
        a(this, pe), this.ttCtx = t, this.ctx = t.ctx, this.w = t.w
    }

    function fe(t) {
        a(this, fe), this.w = t.w, this.ctx = t.ctx, this.ttCtx = t, this.tooltipUtil = new Rt(t)
    }

    function xe(t) {
        a(this, xe), this.w = t.w, this.ttCtx = t, this.ctx = t.ctx
    }

    function c(t) {
        var e;
        return a(this, c), (e = ht.call(this, t)).ctx = t, e.w = t.w, e.dragged = !1, e.graphics = new Y(e.ctx), e.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], e.clientX = 0, e.clientY = 0, e.startX = 0, e.endX = 0, e.dragX = 0, e.startY = 0, e.endY = 0, e.dragY = 0, e.moveDirection = "none", e
    }

    function be(t) {
        a(this, be), this.ctx = t, this.w = t.w;
        t = this.w;
    ...
    function me(t) {
        a(this, me), this.ctx = t, this.w = t.w, this.onLegendClick = this.onLegendClick.bind(this), this.onLegendHovered = this.onLegendHovered.bind(this), this.isBarsDistributed = "bar" === this.w.config.chart.type && this.w.config.plotOptions.bar.distributed && 1 === this.w.config.series.length, this.legendHelpers = new Xt(this)
    }

    function ye(t) {
        a(this, ye), this.w = t.w, this.lgCtx = t
    }

    function ve(t) {
        a(this, ve), this.ctx = t, this.w = t.w, this.lgRect = {}, this.yAxisWidth = 0, this.yAxisWidthLeft = 0, this.yAxisWidthRight = 0, this.xAxisHeight = 0, this.isSparkline = this.w.config.chart.sparkline.enabled, this.dimHelpers = new Pt(this), this.dimYAxis = new Tt(this), this.dimXAxis = new It(this), this.dimGrid = new Mt(this), this.lgWidthForSideLegends = 0, this.gridPad = this.w.config.grid.padding, this.xPadRight = 0, this.xPadLeft = 0
    }
    ...
    function Le(t) {
        a(this, Le), this.ctx = t, this.colors = [], this.w = t.w;
        t = this.w;
    ...
    function ze(t) {
        a(this, ze), this.ctx = t, this.w = t.w, this.documentEvent = E.bind(this.documentEvent, this)
    }

    function Xe(t, e) {
        a(this, Xe), this.ctx = t, this.elgrid = e, this.w = t.w;
        e = this.w;
        this.xaxisFontSize = e.config.xaxis.labels.style.fontSize, this.axisFontFamily = e.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = e.config.xaxis.labels.style.colors, this.isCategoryBarHorizontal = "bar" === e.config.chart.type && e.config.plotOptions.bar.horizontal, this.xAxisoffX = 0, "bottom" === e.config.xaxis.position && (this.xAxisoffX = e.globals.gridHeight), this.drawnLabels = [], this.axesUtils = new L(t)
    }

    function Ee(t) {
        a(this, Ee), this.ctx = t, this.w = t.w, this.scales = new x(t)
    }
    ...
    function Fe(t) {
        a(this, Fe), this.ctx = t, this.w = t.w;
        var e = this.w;
        this.xaxisLabels = e.globals.labels.slice(), this.axesUtils = new L(t), this.isRangeBar = e.globals.seriesRange.length && e.globals.isBarHorizontal, 0 < e.globals.timescaleLabels.length && (this.xaxisLabels = e.globals.timescaleLabels.slice())
    }

    function Re(t, e) {
        a(this, Re), this.ctx = t, this.elgrid = e, this.w = t.w;
        e = this.w;
        this.axesUtils = new L(t), this.xaxisLabels = e.globals.labels.slice(), 0 < e.globals.timescaleLabels.length && !e.globals.isBarHorizontal && (this.xaxisLabels = e.globals.timescaleLabels.slice()), e.config.xaxis.overwriteCategories && (this.xaxisLabels = e.config.xaxis.overwriteCategories), this.drawnLabels = [], this.drawnLabelsRects = [], "top" === e.config.xaxis.position ? this.offY = 0 : this.offY = e.globals.gridHeight + 1, this.offY = this.offY + e.config.xaxis.axisBorder.offsetY, this.isCategoryBarHorizontal = "bar" === e.config.chart.type && e.config.plotOptions.bar.horizontal, this.xaxisFontSize = e.config.xaxis.labels.style.fontSize, this.xaxisFontFamily = e.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = e.config.xaxis.labels.style.colors, this.xaxisBorderWidth = e.config.xaxis.axisBorder.width, this.isCategoryBarHorizontal && (this.xaxisBorderWidth = e.config.yaxis[0].axisBorder.width.toString()), -1 < this.xaxisBorderWidth.indexOf("%") ? this.xaxisBorderWidth = e.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10) / 100 : this.xaxisBorderWidth = parseInt(this.xaxisBorderWidth, 10), this.xaxisBorderHeight = e.config.xaxis.axisBorder.height, this.yaxis = e.config.yaxis[0]
    }
    ...
    function Oe(t) {
        a(this, Oe), this.ctx = t, this.w = t.w, this.twoDSeries = [], this.threeDSeries = [], this.twoDSeriesX = [], this.seriesGoals = [], this.coreUtils = new z(this.ctx)
    }

    function Ne(t) {
        a(this, Ne), this.ctx = t, this.w = t.w, this.legendInactiveClass = "legend-mouseover-inactive"
    }
    ...
    function Be(t) {
        a(this, Be), this.ctx = t, this.w = t.w, this.initialAnim = this.w.config.chart.animations.enabled, this.dynamicAnim = this.initialAnim && this.w.config.chart.animations.dynamicAnimation.enabled
    }
    ...
    function Ve(t) {
        a(this, Ve), this.ctx = t, this.w = t.w, this.opts = null, this.seriesIndex = 0
    }
    ...
    function Ze(t) {
        a(this, Ze), this.ctx = t, this.w = t.w, this.tooltipKeyFormat = "dd MMM"
    }

    function $e(t) {
        a(this, $e), this.ctx = t, this.w = t.w, this.months31 = [1, 3, 5, 7, 8, 10, 12], this.months30 = [2, 4, 6, 9, 11], this.daysCntOfYear = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334]
    }

    function Je(t) {
        a(this, Je), this.ctx = t, this.w = t.w, this.graphics = new Y(this.ctx), this.w.globals.isBarHorizontal && (this.invertAxis = !0), this.helpers = new G(this), this.xAxisAnnotations = new V(this), this.yAxisAnnotations = new j(this), this.pointsAnnotations = new _(this), this.w.globals.isBarHorizontal && this.w.config.yaxis[0].reversed && (this.inversedReversedAxis = !0), this.xDivision = this.w.globals.gridWidth / this.w.globals.dataPoints
    }
    ...
    t(ei, [{
        ...
        value: function(t, e, i, a) {
            ...
            for (var l = [], h = 0; h < t.length; h++) {
                ...
                var c = s.globals.comboCharts ? i[h] : h,
                    ...
                    g = [],
                    u = [],
                    p = s.globals.padHorizontal + this.categoryAxisCorrection;
                this.ctx.series.addCollapsedClassToSeries(this.elSeries, c), s.globals.isXNumeric && 0 < s.globals.seriesX.length && (p = (s.globals.seriesX[c][0] - s.globals.minX) / this.xRatio), u.push(p);
                var f, x = p,
                    b = void 0,
                    m = x,
                    y = this.zeroY,
                    ...
                    p = (d.push(y), f = y, "rangeArea" === r && (b = v = this.lineHelpers.determineFirstPrevY({
                        i: h,
                        series: a,
                        prevY: v,
                        lineYPosition: 0
                    ...
                    x = this._iterateOverDataPoints(T(T({}, p), {}, {
                        iterations: "rangeArea" === r ? t[h].length - 1 : void 0,
                        isRangeStart: !0
                    }));
                "rangeArea" === r && (f = this._calculatePathsFrom({
                    series: a,
                    i: h,
                    realIndex: c,
                    prevX: m,
                    prevY: v
                }), y = this._iterateOverDataPoints(T(T({}, p), {}, {
                    series: a,
                    pY: b,
                    pathsFrom: f,
                    iterations: a[h].length - 1,
                    isRangeStart: !1
                })), x.linePaths[0] = y.linePath + x.linePath, x.pathFromLine = y.pathFromLine + x.pathFromLine), this._handlePaths({
                    type: r,
                    realIndex: c,
                    i: h,
                    paths: x
            ...
            if (s.config.chart.stacked)
                for (var w = l.length; 0 < w; w--) n.add(l[w - 1]);
            else
                for (var k = 0; k < l.length; k++) n.add(l[k]);
            return n
        }
    }, {
        ...
        value: function(t, e, i) {
            var a = this.w,
                s = new Y(this.ctx),
                s = (this.xDivision = a.globals.gridWidth / (a.globals.dataPoints - ("on" === a.config.xaxis.tickPlacement ? 1 : 0)), this.strokeWidth = Array.isArray(a.config.stroke.width) ? a.config.stroke.width[i] : a.config.stroke.width, 1 < this.yRatio.length && (this.yaxisIndex = i), this.isReversed = a.config.yaxis[this.yaxisIndex] && a.config.yaxis[this.yaxisIndex].reversed, this.zeroY = a.globals.gridHeight - this.baseLineY[this.yaxisIndex] - (this.isReversed ? a.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), this.areaBottomY = this.zeroY, (this.zeroY > a.globals.gridHeight || "end" === a.config.plotOptions.area.fillTo) && (this.areaBottomY = a.globals.gridHeight), this.categoryAxisCorrection = this.xDivision / 2, this.elSeries = s.group({
                    class: "apexcharts-series",
        ...
        value: function(t) {
            ...
            } else e = c.move(n, l), "rangeArea" === a && (e = c.move(n, t) + c.line(n, l)), i = c.move(n, this.areaBottomY) + c.line(n, l);
            return a = c.move(-1, this.zeroY) + c.line(-1, this.zeroY), t = c.move(-1, this.zeroY) + c.line(-1, this.zeroY), 0 < h.globals.previousPaths.length && (a = (h = this.lineHelpers.checkPreviousPaths({
                pathFromLine: a,
                pathFromArea: t,
                realIndex: r
            })).pathFromLine, t = h.pathFromArea), {
                prevX: n,
                prevY: l,
                linePath: e,
                areaPath: i,
        ...
        value: function(t) {
            for (var e = t.type, i = t.series, a = t.iterations, s = t.realIndex, o = t.i, r = t.x, n = t.y, l = t.pX, h = t.pY, c = t.pathsFrom, d = t.linePaths, g = t.areaPaths, u = t.seriesIndex, p = t.lineYPosition, f = t.xArrj, x = t.yArrj, b = t.y2Arrj, m = t.isRangeStart, y = t.seriesRangeEnd, v = this.w, w = new Y(this.ctx), k = this.yRatio, A = c.prevY, S = c.linePath, C = c.areaPath, L = c.pathFromLine, P = c.pathFromArea, I = E.isNumber(v.globals.minYArr[s]) ? v.globals.minYArr[s] : v.globals.minY, a = a || (1 < v.globals.dataPoints ? v.globals.dataPoints - 1 : v.globals.dataPoints), T = n, M = 0; M < a; M++) {
                var z = void 0 === i[o][M + 1] || null === i[o][M + 1],
                    X = (v.globals.isXNumeric ? (X = v.globals.seriesX[s][M + 1], r = ((X = void 0 === v.globals.seriesX[s][M + 1] ? v.globals.seriesX[s][a - 1] : X) - v.globals.minX) / this.xRatio) : r += this.xDivision, p = v.config.chart.stacked && 0 < o && v.globals.collapsedSeries.length < v.config.series.length - 1 ? this.prevSeriesY[function(t) {
                        for (var e = t, i = 0; i < v.globals.series.length; i++)
                            if (-1 < v.globals.collapsedSeriesIndices.indexOf(t)) {
                                e--;
                                break
                            }
                        return 0 <= e ? e : 0
                    }(o - 1)][M + 1] : this.zeroY, z ? n = p - I / k[this.yaxisIndex] + 2 * (this.isReversed ? I / k[this.yaxisIndex] : 0) : (n = p - i[o][M + 1] / k[this.yaxisIndex] + 2 * (this.isReversed ? i[o][M + 1] / k[this.yaxisIndex] : 0), "rangeArea" === e && (T = p - y[o][M + 1] / k[this.yaxisIndex] + 2 * (this.isReversed ? y[o][M + 1] / k[this.yaxisIndex] : 0))), f.push(r), x.push(n), b.push(T), this.lineHelpers.calculatePoints({
                        series: i,
                        x: r,
                        y: n,
                        realIndex: s,
                    ...
                    C = z.areaPath,
                    S = z.linePath;
                !this.appendPathFrom || "monotoneCubic" === v.config.stroke.curve && "rangeArea" === e || (L += w.line(r, this.zeroY), P += w.line(r, this.zeroY)), this.handleNullDataPoints(i, X, o, M, s), this._handleMarkersAndLabels({
                    type: e,
                    pointsPos: X,
                    i: o,
                    j: M,
        ...
        value: function(t) {
            var i, a, e = t.type,
                ...
                S = this.areaBottomY;
            return Array.isArray(w.config.stroke.curve) && (A = Array.isArray(v) ? w.config.stroke.curve[v[o]] : w.config.stroke.curve[o]), "smooth" === (A = ("rangeArea" === e && (w.globals.hasNullValues || 0 < w.config.forecastDataPoints.count) || w.globals.hasNullValues) && "monotoneCubic" === A ? "straight" : A) ? (v = .35 * (l - p), w.globals.hasNullValues ? (null !== s[o][n] && (b = null !== s[o][n + 1] ? (x = k.move(p, f) + k.curve(p + v, f, l - v, h, l + 1, h), k.move(p + 1, f) + k.curve(p + v, f, l - v, h, l + 1, h) + k.line(l, S) + k.line(p, S) + "z") : (x = k.move(p, f), k.move(p, f) + "z")), m.push(x), y.push(b)) : (x += k.curve(p + v, f, l - v, h, l, h), b += k.curve(p + v, f, l - v, h, l, h)), p = l, f = h, n === s[o].length - 2 && (b += k.curve(p, f, l, h, l, S) + k.move(l, h) + "z", "rangeArea" === e && t ? x += k.curve(p, f, l, h, l, g) + k.move(l, g) + "z" : w.globals.hasNullValues || (m.push(x), y.push(b)))) : "monotoneCubic" === A ? ("rangeArea" === e ? c.length === w.globals.dataPoints : n === s[o].length - 2) && (v = c.map(function(t, e) {
                return [c[e], d[e]]
            }), v = st(v), x += at(v), b += at(v), p = l, f = h, "rangeArea" === e && t ? (x += k.line(c[c.length - 1], u[u.length - 1]), i = c.slice().reverse(), a = u.slice().reverse(), v = i.map(function(t, e) {
                return [i[e], a[e]]
            }), u = st(v), b = x += at(u)) : b += k.curve(p, f, l, h, l, S) + k.move(l, h) + "z", m.push(x), y.push(b)) : (null === s[o][n + 1] && (x += k.move(l, h), v = w.globals.isXNumeric ? (w.globals.seriesX[r][n] - w.globals.minX) / this.xRatio : l - this.xDivision, b = b + k.line(v, S) + k.move(l, h) + "z"), null === s[o][n] && (x += k.move(l, h), b += k.move(l, S)), "stepline" === A ? (x = x + k.line(l, null, "H") + k.line(null, h, "V"), b = b + k.line(l, null, "H") + k.line(null, h, "V")) : "straight" === A && (x += k.line(l, h), b += k.line(l, h)), n === s[o].length - 2 && (b = b + k.line(l, S) + k.move(l, h) + "z", "rangeArea" === e && t ? x = x + k.line(l, g) + k.move(l, g) + "z" : (m.push(x), y.push(b)))), {
                linePaths: m,
                areaPaths: y,
                pX: p,
                pY: f,
        ...
        value: function(t, e, i, a, s) {
            var o = this.w;
            (null === t[i][a] && o.config.markers.showNullDataPoints || 1 === t[i].length) && null !== (t = this.markers.plotChartMarkers(e, s, a + 1, this.strokeWidth - o.config.markers.strokeWidth / 2, !0)) && this.elPointsMain.add(t)
        }
    }]);
    var ti = ei;
        ...
        for (var a, r = function t(e, i, a, s) {
                ...
                if (0 !== e.length) return r = a.shortestEdge(),
                    function(t, e, i) {
                        ...
                        e = si(t, i), t = si(a, i);
                        return t <= e
                    }(i, o = e[0], r) ? (i.push(o), t(e.slice(1), i, a, s)) : (r = a.cutArea(u(i), s), s.push(a.getCoordinates(i)), t(e, [], r, s)), s;
                s.push(a.getCoordinates(i))
            }(function(t) {
                for (var e = [], i = s * o / u(t), a = 0; a < t.length; a++) e[a] = t[a] * i;
                return e
        ...
        value: function(u) {
            ...
            return f.globals.noData || (e = [], u.forEach(function(t) {
                ...
                var g = x.group({
                        ...
                        seriesName: E.escapeString(f.globals.seriesNames[d]),
                        rel: d + 1,
                        "data:realIndex": d
                    }),
                    e = (f.config.chart.dropShadow.enabled && (e = f.config.chart.dropShadow, new P(p.ctx).dropShadow(i, e, d)), x.group({
                        class: "apexcharts-data-labels"
                    }));
                t.forEach(function(t, e) {
                    var i = t[0],
                        ...
                        s = t[2],
                        o = t[3],
                        r = x.drawRect(i, a, s - i, o - a, 0, "#fff", 1, p.strokeWidth, f.config.plotOptions.treemap.useFillColorAsStroke ? l : f.globals.stroke.colors[d]),
                        n = (r.attr({
                            cx: i,
                            cy: a,
                            index: d,
    ...
    var b, X, ri = ui,
        ni = (t(gi, [{
            ...
            value: function(t, e) {
                ...
                var i = new v(this.ctx),
                    a = (e - t) / 864e5,
                    i = (this.determineInterval(a), n.globals.disableZoomIn = !1, n.globals.disableZoomOut = !1, a < .00011574074074074075 ? n.globals.disableZoomIn = !0 : 5e4 < a && (n.globals.disableZoomOut = !0), i.getTimeUnitsfromTimestamp(t, e, this.utc)),
                ...
                var p = this.timeScaleArray.map(function(t) {
                    ...
                    return "month" === t.unit ? T(T({}, e), {}, {
                        day: 1,
                        value: t.value + 1
                    }) : "day" === t.unit || "hour" === t.unit ? T(T({}, e), {}, {
                        value: t.value
                    }) : "minute" === t.unit ? T(T({}, e), {}, {
                        value: t.value,
                        minute: t.value
            ...
            value: function(t, e) {
                ...
                i.globals.timescaleLabels = t.slice(), new zt(this.ctx).plotCoords()
            }
        }, {
            ...
            value: function(t) {
                var e, i = t.firstVal,
                    ...
                    c = "month",
                    d = 0;
                1 < i.minDate ? (l = (h.determineDaysOfMonths(s + 1, i.minYear) - a + 1) * r, t = E.monthMod(s + 1), i = o + d, a = E.monthMod(t), 0 === (e = t) && (c = "year", e = i, i += d += a = 1), this.timeScaleArray.push({
                    position: l,
                    value: e,
                    unit: c,
                    year: i,
                ...
                for (var g = t + 1, u = l, p = 0; p < n; p++, 0) {
                    0 === (g = E.monthMod(g)) ? (c = "year", d += 1) : c = "month";
            ...
            value: function(t) {
                ...
                var i = t.firstVal,
                    ...
                    d = t,
                    g = e(h, a, s);
                0 === i.minHour && 1 === i.minDate ? (c = 0, d = E.monthMod(i.minMonth), l = "month", h = i.minDate, r++) : 1 !== i.minDate && 0 === i.minHour && 0 === i.minMinute && (c = 0, t = i.minDate, g = e(h = d = t, a, s)), this.timeScaleArray.push({
                    position: c,
                    value: d,
                    unit: l,
        ...
        li = (t(di, [{
            ...
            value: function() {
                ...
                }), t.dom.Paper.node.style.background = e.chart.background, this.setSVGDimensions(), t.dom.elLegendForeign = document.createElementNS(t.SVGNS, "foreignObject"), Y.setAttrs(t.dom.elLegendForeign, {
                    x: 0,
                    y: 0,
                    width: t.svgWidth,
                    height: t.svgHeight
            ...
            value: function(a, t) {
                ...
                if (r.comboCharts) 0 < l.series.length && y.push(i.draw(l.series, "area", l.i)), 0 < d.series.length && (s.config.chart.stacked ? (e = new jt(this.ctx, t), y.push(e.draw(d.series, d.i))) : (this.ctx.bar = new I(this.ctx, t), y.push(this.ctx.bar.draw(d.series, d.i)))), 0 < f.series.length && y.push(i.draw(f.series, "rangeArea", f.i, f.seriesRangeEnd)), 0 < n.series.length && y.push(i.draw(n.series, "line", n.i)), 0 < g.series.length && y.push(x.draw(g.series, "candlestick", g.i)), 0 < u.series.length && y.push(x.draw(u.series, "boxPlot", u.i)), 0 < p.series.length && y.push(this.ctx.rangeBar.draw(p.series, p.i)), 0 < h.series.length && (e = new ti(this.ctx, t, !0), y.push(e.draw(h.series, "scatter", h.i))), 0 < c.series.length && (x = new ti(this.ctx, t, !0), y.push(x.draw(c.series, "bubble", c.i)));
                    ...
                    case "area":
                        ...
                        break;
                    case "bar":
                        y = (o.chart.stacked ? new jt(this.ctx, t) : (this.ctx.bar = new I(this.ctx, t), this.ctx.bar)).draw(r.series);
                        break;
                    case "candlestick":
                        y = new _t(this.ctx, t).draw(r.series, "candlestick");
                        break;
                    case "boxPlot":
                        y = new _t(this.ctx, t).draw(r.series, o.chart.type);
                        break;
                    case "rangeBar":
                        y = this.ctx.rangeBar.draw(r.series);
                        break;
                    case "rangeArea":
                        y = i.draw(r.seriesRangeStart, "rangeArea", void 0, r.seriesRangeEnd);
                        break;
                    case "heatmap":
                        y = new qt(this.ctx, t).draw(r.series);
                        break;
                    case "treemap":
                        y = new ri(this.ctx, t).draw(r.series);
                        break;
                    case "pie":
                    case "donut":
                    case "polarArea":
            ...
            value: function() {
                var t = this.w.globals,
                    e = this.w.config,
                    i = (t.svgWidth = e.chart.width, t.svgHeight = e.chart.height, E.getDimensions(this.el)),
                    a = e.chart.width.toString().split(/[0-9]+/g).pop(),
                    i = ("%" === a ? E.isNumber(i[0]) && (0 === i[0].width && (i = E.getDimensions(this.el.parentNode)), t.svgWidth = i[0] * parseInt(e.chart.width, 10) / 100) : "px" !== a && "" !== a || (t.svgWidth = parseInt(e.chart.width, 10)), e.chart.height.toString().split(/[0-9]+/g).pop());
                "auto" !== t.svgHeight && "" !== t.svgHeight ? "%" === i ? (a = E.getDimensions(this.el.parentNode), t.svgHeight = a[1] * parseInt(e.chart.height, 10) / 100) : t.svgHeight = parseInt(e.chart.height, 10) : t.axisCharts ? t.svgHeight = t.svgWidth / 1.61 : t.svgHeight = t.svgWidth / 1.2, t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), Y.setAttrs(t.dom.Paper.node, {
                    width: t.svgWidth,
                    height: t.svgHeight
            ...
            value: function() {
                ...
                Y.setAttrs(t.dom.elGraphical.node, e)
            }
        }, {
            ...
            value: function() {
                var t = this.w,
                    ...
                    s = (a += t.config.grid.padding.bottom, "top" !== t.config.legend.position && "bottom" !== t.config.legend.position || !t.config.legend.show || t.config.legend.floating || (i = new Et(this.ctx).legendHelpers.getLegendBBox().clwh + 10), t.globals.dom.baseEl.querySelector(".apexcharts-radialbar, .apexcharts-pie")),
                    o = 2.05 * t.globals.radialSize,
                    s = (s && !t.config.chart.sparkline.enabled && 0 !== t.config.plotOptions.radialBar.startAngle && (o = (s = E.getBoundingClientRect(s)).bottom, s = s.bottom - s.top, o = Math.max(2.05 * t.globals.radialSize, s)), o + e.translateY + i + a);
                e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", s), t.config.chart.height && 0 < String(t.config.chart.height).indexOf("%") || (e.dom.elWrap.style.height = s + "px", Y.setAttrs(e.dom.Paper.node, {
                    height: s
            ...
            value: function() {
                var t, e = null,
                    i = this.w;
                return i.globals.axisCharts && ("back" === i.config.xaxis.crosshairs.position && new At(this.ctx).drawXCrosshairs(), "back" === i.config.yaxis[0].crosshairs.position && new At(this.ctx).drawYCrosshairs(), "datetime" === i.config.xaxis.type && void 0 === i.config.xaxis.labels.formatter && (this.ctx.timeScale = new ni(this.ctx), t = [], isFinite(i.globals.minX) && isFinite(i.globals.maxX) && !i.globals.isBarHorizontal ? t = this.ctx.timeScale.calculateTimeScaleTicks(i.globals.minX, i.globals.maxX) : i.globals.isBarHorizontal && (t = this.ctx.timeScale.calculateTimeScaleTicks(i.globals.minY, i.globals.maxY)), this.ctx.timeScale.recalcDimensionsBasedOnFormat(t)), e = new z(this.ctx).getCalculatedRatios()), e
            }
        }, {
            ...
            value: function() {
                var i, a = this,
                    o = this.w;
                o.config.chart.brush.enabled && "function" != typeof o.config.chart.events.selection && ((i = Array.isArray(o.config.chart.brush.targets) || [o.config.chart.brush.target]).forEach(function(t) {
                    ...
                    i.forEach(function(t) {
                        var a = ApexCharts.getChartByID(t),
                            ...
                            t = (o.config.chart.brush.autoScaleYaxis && 1 === a.w.globals.series.length && (s = new x(a).autoScaleY(a, s, e)), a.w.config.yaxis.reduce(function(t, e, i) {
                                return [].concat(m(t), [T(T({}, a.w.config.yaxis[i]), {}, {
                                    min: s[0].min,
                                    max: s[0].max
                                })])
                            }, []));
        ...
        hi = (t(ci, [{
            ...
            value: function(h) {
                ...
                return new Promise(function(n) {
                    ...
                    t && (l = c.ctx.getSyncedCharts()), c.ctx.w.globals.isExecCalled && (l = [c.ctx], c.ctx.w.globals.isExecCalled = !1), l.forEach(function(t, e) {
                        var i = t.w;
                        if (i.globals.shouldAnimate = g, d || (i.globals.resized = !0, i.globals.dataChanged = !0, g && t.series.getPreviousPaths()), h && "object" === y(h) && (t.config = new p(h), h = z.extendArrayProps(t.config, h, i), t.w.globals.chartID !== c.ctx.w.globals.chartID && delete h.series, i.config = E.extend(i.config, h), u) && (i.globals.lastXAxis = h.xaxis ? E.clone(h.xaxis) : [], i.globals.lastYAxis = h.yaxis ? E.clone(h.yaxis) : [], i.globals.initialConfig = E.extend({}, i.config), i.globals.initialSeries = E.clone(i.config.series), h.series)) {
            ...
            value: function(a, s) {
                ...
                return new Promise(function(t) {
                    ...
                    return i.globals.shouldAnimate = s, i.globals.dataChanged = !0, s && o.ctx.series.getPreviousPaths(), i.globals.axisCharts ? (0 === (e = a.map(function(t, e) {
                        ...
                        data: []
                    }]), i.config.series = e) : i.config.series = a.slice(), r && (i.globals.initialConfig.series = E.clone(i.config.series), i.globals.initialSeries = E.clone(i.config.series)), o.ctx.update().then(function() {
                        t(o.ctx)
                    })
                })
            }
            ...
            value: function(t, e) {
                ...
                return i.globals.axisCharts ? a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")).members[0] : void 0 === e && (a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0], "pie" !== i.config.chart.type && "polarArea" !== i.config.chart.type && "donut" !== i.config.chart.type || this.ctx.pie.pieClicked(t)), a ? (new Y(this.ctx).pathMouseDown(a, null), a.node || null) : (console.warn("toggleDataPointSelection: Element not found"), null)
            }
        }, {
    ...
    function ui(t, e) {
        a(this, ui), this.ctx = t, this.w = t.w, this.strokeWidth = this.w.config.stroke.width, this.helpers = new Ut(t), this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.labels = []
    }
    ...
    function xi(t) {
        ...
        switch (t[0]) {
            ...
            case "A":
                t = (e = function(t, e) {
                    var i, a, s, o, r, n, l, h, c, d, g, u, p, f, x, b, m, y, v, w = Math.abs(e[1]),
                        k = Math.abs(e[2]),
                        A = e[3] % 360,
                        S = e[4],
                        C = e[5],
                    ...
                    for (f = 1, x = c.length; f < x; f++) b = (p = c[f - 1][2]).x, m = p.y, y = (p = c[f][0]).x, v = p.y, L = (p = c[f][1]).x, P = p.y, I.push(["C", b, m, y, v, L, P]);
                    return I
                }(this.pos, t))[0]
        }
    ...
    b = "undefined" != typeof window ? window : void 0, X = function(s, o) {
            ...
            h.did = 1e3, h.eid = function(t) {
                ...
                var e, i;
                this.r = 0, this.g = 0, this.b = 0, t && ("string" == typeof t ? h.regex.isRgb.test(t) ? (e = h.regex.rgb.exec(t.replace(h.regex.whitespace, "")), this.r = parseInt(e[1]), this.g = parseInt(e[2]), this.b = parseInt(e[3])) : h.regex.isHex.test(t) && (e = h.regex.hex.exec(4 == (i = t).length ? ["#", i.substring(1, 2), i.substring(1, 2), i.substring(2, 3), i.substring(2, 3), i.substring(3, 4), i.substring(3, 4)].join("") : i), this.r = parseInt(e[1], 16), this.g = parseInt(e[2], 16), this.b = parseInt(e[3], 16)) : "object" === y(t) && (this.r = t.r, this.g = t.g, this.b = t.b))
            }, h.extend(h.Color, {
                toString: function() {
                    return this.toHex()
                },
            ...
            h.PathArray = function(t, e) {
                ...
                create: function(t) {
                    var e = p([1, 0, 0, 1, 0, 0]);
                    t = null === t ? e : t instanceof h.Element ? t.matrixify() : "string" == typeof t ? p(t.split(h.regex.delimiter).map(parseFloat)) : 6 == arguments.length ? p([].slice.call(arguments)) : Array.isArray(t) ? p(t) : t && "object" === y(t) ? t : e;
                ...
                transform: function(t, e) {
                    var i;
                    return "object" !== y(t) ? (i = new h.Matrix(this).extract(), "string" == typeof t ? i[t] : i) : (i = new h.Matrix(this), e = !!e || !!t.relative, null != t.a && (i = e ? i.multiply(new h.Matrix(t)) : new h.Matrix(t)), this.attr("transform", i))
                }
            }), h.extend(h.Element, {
            ...
            return X(b, b.document)
        }) : "object" === ("undefined" == typeof exports ? "undefined" : y(exports)) && "undefined" != typeof module ? module.exports = b.document ? X(b, b.document) : function(t) {
            return X(t, t.document)
        } : b.SVG = X(b, b.document),
        function() {
        ...
        }.call(void 0), F.prototype.init = function(t, e) {
            var i = this.el.bbox(),
    ...
    t(ki, [{
        key: "initModules",
        value: function() {
            this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "exportToCSV", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"], this.ctx.eventList = ["click", "mousedown", "mousemove", "mouseleave", "touchstart", "touchmove", "touchleave", "mouseup", "touchend"], this.ctx.animations = new A(this.ctx), this.ctx.axes = new kt(this.ctx), this.ctx.core = new li(this.ctx.el, this.ctx), this.ctx.config = new p({}), this.ctx.data = new ft(this.ctx), this.ctx.grid = new bt(this.ctx), this.ctx.graphics = new Y(this.ctx), this.ctx.coreUtils = new z(this.ctx), this.ctx.crosshairs = new At(this.ctx), this.ctx.events = new vt(this.ctx), this.ctx.exports = new xt(this.ctx), this.ctx.localization = new wt(this.ctx), this.ctx.options = new d, this.ctx.responsive = new St(this.ctx), this.ctx.series = new C(this.ctx), this.ctx.theme = new Ct(this.ctx), this.ctx.formatters = new f(this.ctx), this.ctx.titleSubtitle = new Lt(this.ctx), this.ctx.legend = new Et(this.ctx), this.ctx.toolbar = new Yt(this.ctx), this.ctx.tooltip = new Bt(this.ctx), this.ctx.dimensions = new zt(this.ctx), this.ctx.updateHelpers = new hi(this.ctx), this.ctx.zoomPanSelection = new Ft(this.ctx), this.ctx.w.globals.tooltip = new Bt(this.ctx)
        }
    }]);
    var mi = ki,
        yi = (t(wi, [{
    ...
    function Ai(t, e) {
        a(this, Ai), this.opts = e, (this.ctx = this).w = new ut(e).init(), this.el = t, this.w.globals.cuid = E.randomId(), this.w.globals.chartID = this.w.config.chart.id ? E.escapeString(this.w.config.chart.id) : this.w.globals.cuid, new mi(this).initModules(), this.create = E.bind(this.create, this), this.windowResizeHandler = this._windowResizeHandler.bind(this), this.parentResizeHandler = this._parentResizeCallback.bind(this)
    }
    return t(Ai, [{
        key: "render",
        value: function() {
        ...
        value: function() {
            ...
            return new Promise(function(t, e) {
                ...
                null !== n && !h.globals.allSeriesCollapsed || l.series.handleNoData(), l.grid = new bt(l);
                e = l.grid.drawGrid();
                if (l.annotations = new dt(l), l.annotations.drawImageAnnos(), l.annotations.drawTextAnnos(), "back" === h.config.grid.position && (e && h.globals.dom.elGraphical.add(e.el), null != e) && null != (s = e.elGridBorders) && s.node && h.globals.dom.elGraphical.add(e.elGridBorders), Array.isArray(n.elGraph))
        ...
        key: "destroy",
        value: function() {
            window.removeEventListener("resize", this.windowResizeHandler), this.el.parentNode, t = this.parentResizeHandler, (e = vi.get(t)) && (e.disconnect(), vi.delete(t));
        ...
        value: function(t) {
            ...
            return this.w.config.series = i, e && (this.w.globals.initialSeries = E.clone(this.w.config.series)), this.update()
        }
    }, {
        key: "update",
        value: function(a) {
        ...
        value: function() {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0;
            return new mt(this.ctx).getMinYMaxY(t).highestY
        }
    }, {
        key: "getLowestValueInSeries",
        value: function() {
            var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 0;
            return new mt(this.ctx).getMinYMaxY(t).lowestY
        }
    }, {
        key: "getSeriesTotal",
        value: function() {

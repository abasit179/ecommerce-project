...
function(e, t) {
    ...
    const c = (e, t = [], n = e) => "function" == typeof e ? e(...t) : n,
        X = (n, i, e = !0) => {
            if (e) {
                ...
                i.addEventListener(q, r), setTimeout(() => {
                    t || R(i)
                }, e)
            } else c(n)
        },
            ...
            if ("string" == typeof t && e) {
                ...
                if (d)
                    for (const _ of Object.keys(c)) {
                        f = h = y = v = m = g = p = void 0;
                        var h, f, p = e,
                            g = c,
                            m = _,
                            v = t.slice(1),
                            y = g[m] || {};
                        for ([h, f] of Object.entries(y)) h.includes(v) && se(p, g, m, f.callable, f.delegationSelector)
                    }
    ...
    const he = t => {
            ...
            if (!n || "#" === n) {
                ...
                e.includes("#") && !e.startsWith("#") && (e = "#" + e.split("#")[1]), n = e && "#" !== e ? F(e.trim()) : null
            }
            return n
        },
        d = {
    ...
    g.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", function(e) {
        ...
        for (const e of d.find('[data-bs-ride="carousel"]')) Oe.getOrCreateInstance(e)
    }), e(Oe);
    const Le = "show",
        m = "collapse",
        je = "collapsing",
    ...
    g.on(document, "click.bs.collapse.data-api", Ne, function(e) {
        ...
        for (const t of d.getMultipleElementsFromSelector(this)) Me.getOrCreateInstance(t, {
            toggle: !1
        }).toggle()
    }), e(Me);
    var A = "top",
        ...
        _completeHide(e) {
            ...
            if (!t.defaultPrevented) {
                if ("ontouchstart" in document.documentElement)
                    for (const n of [].concat(...document.body.children)) g.off(n, "mouseover", W);
        ...
        static clearMenus(e) {
            if (2 !== e.button && ("keyup" !== e.type || "Tab" === e.key))
                for (const r of d.find('[data-bs-toggle="dropdown"]:not(.disabled):not(:disabled).show')) {
                    var t, n, i = k.getInstance(r);
                    i && !1 !== i._config.autoClose && (t = (n = e.composedPath()).includes(i._menu), n.includes(i._element) || "inside" === i._config.autoClose && !t || "outside" === i._config.autoClose && t || i._menu.contains(e.target) && ("keyup" === e.type && "Tab" === e.key || /input|select|option|textarea|form/i.test(e.target.tagName)) || (n = {
                        relatedTarget: i._element
                    }, "click" === e.type && (n.clickEvent = e), i._completeHide(n)))
                }
        }
    ...
    class Sn extends t {
        ...
        _triggerBackdropTransition() {
            ...
            if (!e.defaultPrevented) {
                ...
                "hidden" === t || this._element.classList.contains(Cn) || (e || (this._element.style.overflowY = "hidden"), this._element.classList.add(Cn), this._queueCallback(() => {
    ...
    g.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(e) {
        ...
        for (const e of d.find(On)) P.getOrCreateInstance(e).show()
    ...
    class Kn extends t {
            ...
            if (this._isShown()) {
                ...
                if (!e.defaultPrevented) {
                    if (this._getTipElement().classList.remove($n), "ontouchstart" in document.documentElement)
                        for (const t of [].concat(...document.body.children)) g.off(t, "mouseover", W);
        ...
        _setListeners() {
            ...
            }) : "manual" !== n && (e = n === Xn ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"), t = n === Xn ? this.constructor.eventName("mouseleave") : this.constructor.eventName("focusout"), g.on(this._element, e, this._config.selector, e => {
        ...
        _activateParents(e) {
            if (e.classList.contains("dropdown-item")) d.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(ni);
                ...
                for (const t of d.parents(e, ".nav, .list-group"))
                    for (const n of d.prev(t, ".nav-link, .nav-item > .nav-link, .list-group-item")) n.classList.add(ni)
        }
        _clearActiveClass(e) {
    ...
    const hi = '.nav-link:not(.dropdown-toggle), .list-group-item:not(.dropdown-toggle), [role="tab"]:not(.dropdown-toggle), ' + yt;
    I, I, I;
    class fi extends t {
        constructor(e) {

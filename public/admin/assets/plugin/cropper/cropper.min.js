...
! function(t, e) {
    ...
    function l(a, i) {
        var o = t("<canvas>")[0],
            ...
            b = void 0,
            y = void 0;
        return g && (w = v / 2, b = x / 2), m && (y = p({
            width: v,
            height: x,
            degree: c
        }), v = y.width, x = y.height, w = v / 2, b = x / 2), o.width = v, o.height = x, u && (r = -s / 2, h = -d / 2, n.save(), n.translate(w, b)), m && n.rotate(c * Math.PI / 180), g && n.scale(l, f), n.drawImage(a, Math.floor(r), Math.floor(h), Math.floor(s), Math.floor(d)), u && n.restore(), o
    }
    ...
    function g(t) {
        ...
        if (d && (o = d + 4, n = d + 10, "Exif" === f(e, o, 4) && (s = e.getUint16(n), h = 18761 === s, (h || 19789 === s) && 42 === e.getUint16(n + 2, h) && (r = e.getUint32(n + 4, h), r >= 8 && (c = n + r)))), c)
        ...
        D = {
            ...
            initCanvas: function() {
                var e = this,
                    ...
                    f = o,
                    g = n;
                n * l > o ? 3 === a ? f = n * l : g = o / l : 3 === a ? g = o / l : f = n * l;
                var m = {
                    naturalWidth: c,
                    naturalHeight: p,
                    aspectRatio: l,
                ...
                m.oldLeft = m.left = (o - f) / 2, m.oldTop = m.top = (n - g) / 2, e.canvas = m, e.limited = 1 === a || 2 === a, e.limitCanvas(!0, !0), e.initialImage = t.extend({}, r), e.initialCanvas = t.extend({}, m)
            },
            limitCanvas: function(t, e) {
                ...
                if (t) {
                    ...
                    o && (o > 1 ? (l = Math.max(l, r), f = Math.max(f, h), 3 === o && (f * d > l ? l = f * d : f = l / d)) : l ? l = Math.max(l, p ? c.width : 0) : f ? f = Math.max(f, p ? c.height : 0) : p && (l = c.width, f = c.height, f * d > l ? l = f * d : f = l / d)), l && f ? f * d > l ? f = l / d : l = f * d : l ? f = l / d : f && (l = f * d), s.minWidth = l, s.minHeight = f, s.maxWidth = 1 / 0, s.maxHeight = 1 / 0
                }
                if (e)
                    if (o) {
                        var g = r - s.width,
                            m = h - s.height;
                        s.minLeft = Math.min(0, g), s.minTop = Math.min(0, m), s.maxLeft = Math.max(0, g), s.maxTop = Math.max(0, m), p && a.limited && (s.minLeft = Math.min(c.left, c.left + c.width - s.width), s.minTop = Math.min(c.top, c.top + c.height - s.height), s.maxLeft = c.left, s.maxTop = c.top, 2 === o && (s.width >= r && (s.minLeft = Math.min(0, g), s.maxLeft = Math.max(0, g)), s.height >= h && (s.minTop = Math.min(0, m), s.maxTop = Math.max(0, m))))
            ...
            renderCanvas: function(t) {
                ...
                }(a.width > a.maxWidth || a.width < a.minWidth) && (a.left = a.oldLeft), (a.height > a.maxHeight || a.height < a.minHeight) && (a.top = a.oldTop), a.width = Math.min(Math.max(a.width, a.minWidth), a.maxWidth), a.height = Math.min(Math.max(a.height, a.minHeight), a.maxHeight), e.limitCanvas(!1, !0), a.oldLeft = a.left = Math.min(Math.max(a.left, a.minLeft), a.maxLeft), a.oldTop = a.top = Math.min(Math.max(a.top, a.minTop), a.maxTop), e.$canvas.css({
                    width: a.width,
                    height: a.height,
                    transform: c({
                        translateX: a.left,
            ...
            limitCropBox: function(t, e) {
                ...
                if (t) {
                    ...
                    p = Math.min(p, r), l = Math.min(l, h), o && (p && l ? l * o > p ? l = p / o : p = l * o : p ? l = p / o : l && (p = l * o), g * o > f ? g = f / o : f = g * o), d.minWidth = Math.min(p, f), d.minHeight = Math.min(l, g), d.maxWidth = f, d.maxHeight = g
                }
            ...
            preview: function() {
                ...
                e.cropped && !e.disabled && (e.$clone2.css({
                    ...
                    var o = t(i),
                        ...
                        u = g,
                        v = 1;
                    n && (v = f / n, u = r * v), r && u > g && (v = g / r, m = n * v, u = g), o.css({
                        width: m,
                        height: u
                    }).find("img").css({
                        width: h * v,
        ...
        _ = {
            change: function(e) {
                var a = this,
                    ...
                    M = !0,
                    $ = void 0;
                !p && e.shiftKey && (p = l && f ? l / f : 1), a.limited && (w = d.minLeft, b = d.minTop, y = w + Math.min(h.width, s.width, s.left + s.width), C = b + Math.min(h.height, s.height, s.top + s.height));
                var B = {
                    x: r.endX - r.startX,
                    y: r.endY - r.startY
                };
                switch (p && (B.X = B.y * p, B.Y = B.x / p), c) {
                    ...
                    case q:
                        ...
                        l += B.x, p && (f = l / p, m -= B.Y / 2), l < 0 && (c = S, l = 0);
                        break;
                    case Z:
                        ...
                        f -= B.y, m += B.y, p && (l = f * p, g += B.X / 2), f < 0 && (c = K, f = 0);
                        break;
                    case S:
                        ...
                        l -= B.x, g += B.x, p && (f = l / p, m += B.Y / 2), l < 0 && (c = q, l = 0);
                        break;
                    case K:
                        ...
                        f += B.y, p && (l = f * p, g -= B.X / 2), f < 0 && (c = Z, f = 0);
                        break;
                    case J:
                        if (p) {
                            if (B.y <= 0 && (m <= b || u >= y)) {
                            ...
                            f -= B.y, m += B.y, l = f * p
                        } else B.x >= 0 ? u < y ? l += B.x : B.y <= 0 && m <= b && (M = !1) : l += B.x, B.y <= 0 ? m > b && (f -= B.y, m += B.y) : (f -= B.y, m += B.y);
                        l < 0 && f < 0 ? (c = G, f = 0, l = 0) : l < 0 ? (c = Q, l = 0) : f < 0 && (c = V, f = 0);
                        break;
                    case Q:
                        if (p) {
                            if (B.y <= 0 && (m <= b || g <= w)) {
                        ...
                        } else B.x <= 0 ? g > w ? (l -= B.x, g += B.x) : B.y <= 0 && m <= b && (M = !1) : (l -= B.x, g += B.x), B.y <= 0 ? m > b && (f -= B.y, m += B.y) : (f -= B.y, m += B.y);
                        l < 0 && f < 0 ? (c = V, f = 0, l = 0) : l < 0 ? (c = J, l = 0) : f < 0 && (c = G, f = 0);
                        break;
                    case G:
                        if (p) {
                            if (B.x <= 0 && (g <= w || v >= C)) {
                            ...
                            l -= B.x, g += B.x, f = l / p
                        } else B.x <= 0 ? g > w ? (l -= B.x, g += B.x) : B.y >= 0 && v >= C && (M = !1) : (l -= B.x, g += B.x), B.y >= 0 ? v < C && (f += B.y) : f += B.y;
                        l < 0 && f < 0 ? (c = J, f = 0, l = 0) : l < 0 ? (c = V, l = 0) : f < 0 && (c = Q, f = 0);
                        break;
                    case V:
                        if (p) {
                            if (B.x >= 0 && (u >= y || v >= C)) {
                            ...
                            l += B.x, f = l / p
                        } else B.x >= 0 ? u < y ? l += B.x : B.y >= 0 && v >= C && (M = !1) : l += B.x, B.y >= 0 ? v < C && (f += B.y) : f += B.y;
                        l < 0 && f < 0 ? (c = Q, f = 0, l = 0) : l < 0 ? (c = G, l = 0) : f < 0 && (c = J, f = 0);
                        break;
                    case "move":
                        a.move(B.x, B.y), M = !1;
                        break;
                    ...
                    case "crop":
                        ...
                        $ = a.$cropper.offset(), g = r.startX - $.left, m = r.startY - $.top, l = d.minWidth, f = d.minHeight, B.x > 0 ? c = B.y > 0 ? V : J : B.x < 0 && (g -= l, c = B.y > 0 ? G : Q), B.y < 0 && (m -= f), a.cropped || (a.$cropBox.removeClass("cropper-hidden"), a.cropped = !0, a.limited && a.limitCropBox(!0, !0))
                }
                M && (d.width = l, d.height = f, d.left = g, d.top = m, a.action = c, a.renderCropBox()), t.each(o, function(t, e) {
        ...
        it = {
            ...
            zoomTo: function(t, e) {
                ...
                if (t = Number(t), t >= 0 && a.ready && !a.disabled && i.zoomable) {
                    var p = d * t,
                        l = c * t,
                        f = void 0;
                    if (e && (f = e.originalEvent), a.trigger("zoom", {
                            originalEvent: f,
                            oldRatio: h / d,
                            ratio: p / d
                        }).isDefaultPrevented()) return;
                    if (f) {
                        ...
                        r.left -= (p - h) * ((m.pageX - g.left - r.left) / h), r.top -= (l - s) * ((m.pageY - g.top - r.top) / s)
            ...
            getCroppedCanvas: function(e) {
                ...
                var c = Math.floor(h || o),
                    ...
                    f = t("<canvas>")[0],
                    g = f.getContext("2d");
                f.width = c, f.height = p, e.fillColor && (g.fillStyle = e.fillColor, g.fillRect(0, 0, c, p));
                var m = function() {

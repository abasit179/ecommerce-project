                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                ...
                                <a href="{{route('admin.brands.create')}}" class="btn btn-primary py-2 px-5 btn-set-task w-sm-100"><i class="icofont-plus-circle me-2 fs-6"></i> Add Brands</a>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                        <a href="{{ route('admin.brands.edit', $brand) }}" class="btn btn-outline-secondary"><i class="fas fa-edit text-success"></i></a>

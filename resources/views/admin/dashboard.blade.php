                    ...
                    <div class="tab-filter d-flex align-items-center justify-content-between mb-3 flex-wrap">
                        ...
                        <div class="date-filter d-flex align-items-center mt-2 mt-sm-0 w-sm-100">
                            <div class="input-group">
                                ...
                                <button class="btn btn-primary" type="button"><i class="fas fa-filter fs-5"></i></button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card">
                                        <div
                                            ...
                                            <div class="right-icon">
                                                <i class="fas fa-users fs-3 color-light-orange"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="card">
                                        <div
                                            ...
                                            <div class="right-icon">
                                                <i class="fas fa-shopping-cart fs-3 color-lavender-purple"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="card">
                                        <div
                                            ...
                                            <div class="right-icon">
                                                <i class="fas fa-chart-bar fs-3 color-lightblue"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="card">
                                        <div
                                            ...
                                            <div class="right-icon">
                                                <i class="fas fa-eye fs-3 color-light-success"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="card">
                                        <div
                                            ...
                                            <div class="right-icon">
                                                <i class="fas fa-boxes fs-3 color-light-orange"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                    <div class="card">
                                        <div
                                            ...
                                            <div class="right-icon">
                                                <i class="fas fa-star fs-3 color-lightyellow"></i>
                                            </div>
                                        </div>
                                    </div>
                                </div>

    ...
    <script src="{{url('https://cdn.ckeditor.com/ckeditor5/29.0.0/classic/ckeditor.js')}}"></script>
   ...
   <!-- Jquery Core Js -->
    ...
    <script src="{{url('admin/assets/bundles/dropify.bundle.js')}}"></script>

    <!-- Plugin Js -->
    <script src="{{url('admin/assets/bundles/apexcharts.bundle.js')}}"></script>
    <script src="{{url('admin/assets/bundles/dataTables.bundle.js')}}"></script>
    ...
    <script src="{{url('assets/plugin/multi-select/js/jquery.multi-select.js')}}"></script>
    <script src="{{url('assets/plugin/bootstrap-tagsinput/bootstrap-tagsinput.js')}}"></script>
    <script src="{{url('assets/plugin/cropper/cropper.min.js')}}"></script>
    <script src="{{url('assets/plugin/cropper/cropper-init.js')}}"></script>

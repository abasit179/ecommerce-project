...
<head>
    ...
    <!-- project css file  -->
    <link rel="stylesheet" href="{{url('admin/assets/css/ebazar.style.min.css')}}">
</head>
                    ...
                    <div class="row g-0">
                        {{-- <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center rounded-lg auth-h100">
                            <div style="max-width: 25rem;">
                                ...
                                <!-- Image block -->
                                <div class="">
                                    <img src="{{url('admin/assets/images/login-img.svg')}}" alt="login-img">
                                </div>
                            </div>
                        </div> --}}
                        ...
                        <div class="col-lg-12 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" method="POST" action="{{route('admin.login.submit')}}">
                                    @csrf
                                    <div class="col-12 text-center mb-5">
                                        <h1>Admin Sign in</h1>
                                        {{-- <span> Go to the admin Dashboard.</span> --}}
                                    </div>
                                    <div class="col-12 text-center mb-4">
                                        <a class="btn btn-lg btn-light btn-block" href="#">
                                            <span class="d-flex justify-content-center align-items-center">
                                                <img class="avatar xs me-2" src="{{url('admin/assets/images/google.svg')}}" alt="Image Description">
                                                Sign in with Google
                                            </span>
                                        </a>
                                        ...
                                        <div class="mb-2">
                                            <div class="form-label">
                                                <span class="d-flex justify-content-between align-items-center">
                                                    Password
                                                    <a class="text-secondary" href="{{route('admin.password.request')}}">Forgot Password?</a>
                                                </span>
                                            </div>

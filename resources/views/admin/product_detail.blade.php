                                ...
                                <div class="row align-items-center">
                                        ...
                                        <div class="product-details-image mt-50">
                                            <div class="product-thumb-image">
                                                <div class="product-thumb-image-active nav flex-column nav-pills me-3"
                                                    ...
                                                    @foreach (json_decode($product->images) as $key => $image)
                                                        <a class="single-thumb {{ $key == 0 ? 'active' : '' }}"
                                                            id="v-pills-{{ $key }}-tab" data-bs-toggle="pill"
                                                            href="#v-pills-{{ $key }}" role="button"
                                            ...
                                            <div class="product-image">
                                                <div class="product-image-active tab-content" id="v-pills-tabContent">
                                                    @foreach (json_decode($product->images) as $key => $image)
                                                        <a class="single-image tab-pane fade {{ $key == 0 ? 'active show' : '' }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="product-details-content mt-45">
                                            <h2 class="fw-bold fs-4">{{ $product->title }}</h2>
                                            ...
                                            <div class="product-price">
                                                ...
                                                <p class="sale-price">$ {{ $product->discounted_price }}</p>
                                                <p class="regular-price text-danger">$ {{ $product->original_price }}</p>
                                            </div>
                                                    ...
                                                    <div class="card-body p-lg-4 p-3">
                                                        ...
                                                        <div class="timeline-item-post">
                                                            ...
                                                            <p> A good fit for many households, this Oculus VR has a movable
                                                                ...
                                                                pick is
                                                                quiet and an energy-saving option, resulting in a lower
                                                                energy bill.</p>
                                                        </div>
                                                    </div>
                                                </li>
                            ...
                            <div class="tab-pane fade" id="about">
                                <div class="card-body">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse aliquet sem in
                                        ...
                                        sagittis, lorem magna cursus tortor, molestie
                                        venenatis odio nunc quis eros.Morbi volutpat dui vitae efficitur posuere.</p>
                                    <p>Donec ut libero imperdiet, eleifend ipsum vitae, laoreet nisl. Morbi volutpat dui
                                        ...
                                        viverra magna. Phasellus vitae erat porta, condimentum
                                        enim ac, luctus dui. Fusce dignissim, neque quis aliquet posuere, ante tortor
                                        lobortis eros, et facilisis dolor ipsum malesuada ante.</p>
                                </div>
                            </div>
                        </div>
                    </div>

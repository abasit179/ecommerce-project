                    ...
                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <select name="country" id="country" class="form-control" >
                                                    ...
                                                    <option value="pakistan" {{ (!empty($customerAddress) && $customerAddress->country == 'pakistan') ? 'selected' : '' }}>Pakistan</option>
                        ...
                        <div class="col-md-4">
                                ...
                                <div class="card-body">
                                    ...
                                    @foreach (Cart::content() as $item)
                                        <div class="d-flex justify-content-between pb-2">
                                            <div class="h6">({{ Str::limit($item->name, 18) }}) X {{ $item->qty }}
                                            </div>
                            ...
                            <div class="card payment-form ">
                                ...
                                {{-- <div class="card-body p-0 mt-3 d-none" id="card_payment_form">
                                    <div class="mb-3">

                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/images/carousel-1.jpg') }}" alt="Kids Fashion" />
                        </picture>
                    ...
                    <div class="carousel-item">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/images/carousel-2.jpg') }}" alt="Womens Fashion" />
                        </picture>
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3">
                    ...
                    <div class="carousel-item">
                        <picture>
                            ...
                            <img src="{{ asset('frontend/images/carousel-3.jpg') }}" alt="Shop Online" />
                        </picture>
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3">

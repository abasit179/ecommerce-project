            ...
            <nav class="navbar navbar-expand-xl" id="navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('frontend.home') }}"
                        ...
                        @foreach ($navCategories as $index => $category)
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-dark"
                                        ...
                                        @foreach ($category->subcategories as $subcategory)
                                            <li>
                                                <a class="dropdown-item nav-link"
                                                    href="{{ route('frontend.shop', [$category->name, $subcategory->name]) }}">
                                                    {{ $subcategory->name }}
                                                </a>
                                            </li>
                                        @endforeach
                                    @else
                                        <li>
                                            <a class="dropdown-item nav-link text-muted" href="#">
                                                No subcategories
                                            </a>
                                        </li>
                                    @endif
